...
/**
 * <p>Java class for JokerExprBinding complex type.
 * 
...
@XmlType(name = "JokerExprBinding", propOrder = {
    "jokerExpr",
    "expr"
})
public class JokerExprBinding
    extends Binding
{

    @XmlElementRef(name = "JokerExpr", namespace = "http://czt.sourceforge.net/zpatt", type = JAXBElement.class)
    protected JAXBElement<JokerExpr> jokerExpr;
     ...
     *     
     */
    public JAXBElement<JokerExpr> getJokerExpr() {
        return jokerExpr;
    }
     ...
     *     
     */
    public void setJokerExpr(JAXBElement<JokerExpr> value) {
        this.jokerExpr = value;
    }
