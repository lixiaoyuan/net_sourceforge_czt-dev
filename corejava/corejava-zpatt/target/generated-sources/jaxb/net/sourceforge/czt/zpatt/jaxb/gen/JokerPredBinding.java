...
/**
 * <p>Java class for JokerPredBinding complex type.
 * 
...
@XmlType(name = "JokerPredBinding", propOrder = {
    "jokerPred",
    "pred"
})
public class JokerPredBinding
    extends Binding
{

    @XmlElementRef(name = "JokerPred", namespace = "http://czt.sourceforge.net/zpatt", type = JAXBElement.class)
    protected JAXBElement<JokerPred> jokerPred;
     ...
     *     
     */
    public JAXBElement<JokerPred> getJokerPred() {
        return jokerPred;
    }
     ...
     *     
     */
    public void setJokerPred(JAXBElement<JokerPred> value) {
        this.jokerPred = value;
    }
