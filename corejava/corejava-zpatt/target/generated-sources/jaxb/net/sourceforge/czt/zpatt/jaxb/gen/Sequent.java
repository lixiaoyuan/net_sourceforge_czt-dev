...
/**
 * <p>Java class for Sequent complex type.
 * 
...
@XmlType(name = "Sequent", propOrder = {
    "sequentContext",
    "pred"
})
    ...
    extends Term
{
    ...
    @XmlElementRef(name = "SequentContext", namespace = "http://czt.sourceforge.net/zpatt", type = JAXBElement.class)
    protected JAXBElement<SequentContext> sequentContext;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SequentContext }{@code >}
     *     
     */
    public JAXBElement<SequentContext> getSequentContext() {
     ...
     *     
     */
    public void setSequentContext(JAXBElement<SequentContext> value) {
        this.sequentContext = value;
    }
