 ...
 * {@link net.sourceforge.czt.zpatt.ast.JokerPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class JokerPredImpl
extends 		 						net.sourceforge.czt.z.impl.PredImpl
			 	  implements net.sourceforge.czt.zpatt.ast.JokerPred
{
  ...
  /**
   * static instance count for JokerPredImpl
   */
   ...
   * this instance of JokerPredImpl (e.g., ic >= sl)
   */
  ...
  protected JokerPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (name_ != null) {
          if (!name_.equals(((JokerPredImpl) obj).name_)) {
            return false;
          }
        }
        else {
          if (((JokerPredImpl) obj).name_ != null) {
            return false;
          }
        }
        if (id_ != null) {
          if (!id_.equals(((JokerPredImpl) obj).id_)) {
            return false;
          }
        }
        else {
          if (((JokerPredImpl) obj).id_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.zpatt.visitor.JokerPredVisitor) {
      net.sourceforge.czt.zpatt.visitor.JokerPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.zpatt.visitor.JokerPredVisitor<R>) v;
