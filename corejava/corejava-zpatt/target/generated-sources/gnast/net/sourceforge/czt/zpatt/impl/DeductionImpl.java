 ...
 * {@link net.sourceforge.czt.zpatt.ast.Deduction}.
 *
 * @author GnAST version 1.6-cdh
 */
public abstract class DeductionImpl
extends   		net.sourceforge.czt.base.impl.TermImpl
	  implements net.sourceforge.czt.zpatt.ast.Deduction
{
  ...
  protected DeductionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.zpatt.visitor.DeductionVisitor) {
      net.sourceforge.czt.zpatt.visitor.DeductionVisitor<R> visitor = 
      	  (net.sourceforge.czt.zpatt.visitor.DeductionVisitor<R>) v;
