 ...
 * {@link net.sourceforge.czt.zpatt.ast.SequentList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.zpatt.ast.Sequent + net.sourceforge.czt.zpatt.ast

public class SequentListImpl
  extends java.util.AbstractList<net.sourceforge.czt.zpatt.ast.Sequent>
  implements net.sourceforge.czt.zpatt.ast.SequentList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.zpatt.ast.Sequent> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for SequentListImpl
   */
   ...
   * this instance of SequentListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected SequentListImpl()
  {
    this(null);
  }

  protected SequentListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.zpatt.ast.Sequent> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.zpatt.ast.Sequent>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.zpatt.ast.SequentList getSequent()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.zpatt.ast.Sequent element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zpatt.ast.Sequent get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zpatt.ast.Sequent remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zpatt.ast.Sequent set(int index, net.sourceforge.czt.zpatt.ast.Sequent element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.zpatt.visitor.SequentListVisitor) {
      net.sourceforge.czt.zpatt.visitor.SequentListVisitor<R> visitor = 
      		(net.sourceforge.czt.zpatt.visitor.SequentListVisitor<R>) v;
      return visitor.visitSequentList(this);
    }
  ...
  @Override
  public SequentListImpl create(Object[] args)
  {
    SequentListImpl result = new SequentListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.zpatt.ast.Sequent) args[i]);
    }
    return result;
  }
}
