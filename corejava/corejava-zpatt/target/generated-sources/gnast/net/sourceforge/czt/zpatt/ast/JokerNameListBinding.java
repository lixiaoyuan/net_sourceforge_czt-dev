...
public interface JokerNameListBinding extends 		 		net.sourceforge.czt.zpatt.ast.Binding
 			{

  /**
   * Returns the JokerNameList element.
   *
   * @return the JokerNameList element.
   */
  net.sourceforge.czt.zpatt.ast.JokerNameList getJokerNameList();


  /**
   * Sets the JokerNameList element.
   *
   * @param jokerNameList   the JokerNameList element.
   * @see #getJokerNameList
   */
  void setJokerNameList(net.sourceforge.czt.zpatt.ast.JokerNameList jokerNameList);
