 ...
 * {@link net.sourceforge.czt.zpatt.ast.JokerDeclList}.
 *
 * @author GnAST version 1.6-cdh
 */
public class JokerDeclListImpl
extends 		 						net.sourceforge.czt.z.impl.DeclListImpl
			 	  implements net.sourceforge.czt.zpatt.ast.JokerDeclList
{
  ...
  /**
   * static instance count for JokerDeclListImpl
   */
   ...
   * this instance of JokerDeclListImpl (e.g., ic >= sl)
   */
  ...
  protected JokerDeclListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (name_ != null) {
          if (!name_.equals(((JokerDeclListImpl) obj).name_)) {
            return false;
          }
        }
        else {
          if (((JokerDeclListImpl) obj).name_ != null) {
            return false;
          }
        }
        if (id_ != null) {
          if (!id_.equals(((JokerDeclListImpl) obj).id_)) {
            return false;
          }
        }
        else {
          if (((JokerDeclListImpl) obj).id_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.zpatt.visitor.JokerDeclListVisitor) {
      net.sourceforge.czt.zpatt.visitor.JokerDeclListVisitor<R> visitor = 
      	  (net.sourceforge.czt.zpatt.visitor.JokerDeclListVisitor<R>) v;
