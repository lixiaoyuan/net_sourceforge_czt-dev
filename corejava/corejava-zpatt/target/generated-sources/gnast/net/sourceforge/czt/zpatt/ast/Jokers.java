...
public interface Jokers extends 		 						net.sourceforge.czt.z.ast.Para
			 			{
  ...
  /**
   * Returns the JokerType element.
   *
   * @return the JokerType element.
   */
  JokerType getJokerType();


  /**
   * Sets the JokerType element.
   *
   * @param jokerType   the JokerType element.
   * @see #getJokerType
   */
  void setJokerType(JokerType jokerType);
}
