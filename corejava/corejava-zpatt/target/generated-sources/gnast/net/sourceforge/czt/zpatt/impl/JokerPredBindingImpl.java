 ...
 * {@link net.sourceforge.czt.zpatt.ast.JokerPredBinding}.
 *
 * @author GnAST version 1.6-cdh
 */
public class JokerPredBindingImpl
extends 		 		net.sourceforge.czt.zpatt.impl.BindingImpl
 	  implements net.sourceforge.czt.zpatt.ast.JokerPredBinding
{
  ...
  /**
   * static instance count for JokerPredBindingImpl
   */
   ...
   * this instance of JokerPredBindingImpl (e.g., ic >= sl)
   */
  ...
  protected JokerPredBindingImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (jokerPred_ != null) {
          if (!jokerPred_.equals(((JokerPredBindingImpl) obj).jokerPred_)) {
            return false;
          }
        }
        else {
          if (((JokerPredBindingImpl) obj).jokerPred_ != null) {
            return false;
          }
        }
        if (pred_ != null) {
          if (!pred_.equals(((JokerPredBindingImpl) obj).pred_)) {
            return false;
          }
        }
        else {
          if (((JokerPredBindingImpl) obj).pred_ != null) {
            return false;
          }
        }
        return true;
  ...
  public int hashCode()
  {
    ...
    if (jokerPred_ != null) {
      hashCode += 31 * jokerPred_.hashCode();
    }
    if (pred_ != null) {
  ...
  {
    if (v instanceof net.sourceforge.czt.zpatt.visitor.JokerPredBindingVisitor) {
      net.sourceforge.czt.zpatt.visitor.JokerPredBindingVisitor<R> visitor = 
      	  (net.sourceforge.czt.zpatt.visitor.JokerPredBindingVisitor<R>) v;
  ...
  public JokerPredBindingImpl create(Object[] args)
  {
    ...
    try {
						...
						net.sourceforge.czt.zpatt.ast.JokerPred) args[0];
  ...
  private
            		net.sourceforge.czt.zpatt.ast.JokerPred
  jokerPred_;
