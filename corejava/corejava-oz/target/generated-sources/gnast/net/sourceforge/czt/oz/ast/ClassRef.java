...
public interface ClassRef extends   		net.sourceforge.czt.base.ast.Term
			{
   ...
   */
  net.sourceforge.czt.z.ast.ZName getName();
   ...
   * @see #getName
   */
  void setName(net.sourceforge.czt.z.ast.ZName name);
