 ...
 * {@link net.sourceforge.czt.oz.ast.PolyExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class PolyExprImpl
extends 		 						net.sourceforge.czt.z.impl.Expr1Impl
						 	  implements net.sourceforge.czt.oz.ast.PolyExpr
{
  ...
  /**
   * static instance count for PolyExprImpl
   */
   ...
   * this instance of PolyExprImpl (e.g., ic >= sl)
   */
  ...
  protected PolyExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.PolyExprVisitor) {
      net.sourceforge.czt.oz.visitor.PolyExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.PolyExprVisitor<R>) v;
