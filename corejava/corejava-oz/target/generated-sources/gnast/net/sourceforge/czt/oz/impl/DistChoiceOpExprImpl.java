 ...
 * {@link net.sourceforge.czt.oz.ast.DistChoiceOpExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class DistChoiceOpExprImpl
extends 		 		net.sourceforge.czt.oz.impl.DistOpExprImpl
 	  implements net.sourceforge.czt.oz.ast.DistChoiceOpExpr
{
  ...
  /**
   * static instance count for DistChoiceOpExprImpl
   */
   ...
   * this instance of DistChoiceOpExprImpl (e.g., ic >= sl)
   */
  ...
  protected DistChoiceOpExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.DistChoiceOpExprVisitor) {
      net.sourceforge.czt.oz.visitor.DistChoiceOpExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.DistChoiceOpExprVisitor<R>) v;
