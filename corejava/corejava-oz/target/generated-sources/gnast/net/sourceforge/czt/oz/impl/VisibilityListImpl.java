 ...
 * {@link net.sourceforge.czt.oz.ast.VisibilityList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.ZName + net.sourceforge.czt.z.ast

public class VisibilityListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.ZName>
  implements net.sourceforge.czt.oz.ast.VisibilityList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.ZName> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for VisibilityListImpl
   */
   ...
   * this instance of VisibilityListImpl (e.g., ic >= sl)
   */
  ...
  protected VisibilityListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.ZName> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.ZName>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.oz.ast.VisibilityList getZName()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.ZName element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.ZName get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.ZName remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.ZName set(int index, net.sourceforge.czt.z.ast.ZName element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.VisibilityListVisitor) {
      net.sourceforge.czt.oz.visitor.VisibilityListVisitor<R> visitor = 
      		(net.sourceforge.czt.oz.visitor.VisibilityListVisitor<R>) v;
  ...
  public VisibilityListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.ZName) args[i]);
    }
    return result;
  }
}
