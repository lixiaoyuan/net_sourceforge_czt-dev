 ...
 * {@link net.sourceforge.czt.oz.ast.DeltaList}.
 *
...
public class DeltaListImpl
  ...
  implements net.sourceforge.czt.oz.ast.DeltaList
{
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for DeltaListImpl
   */
   ...
   * this instance of DeltaListImpl (e.g., ic >= sl)
   */
  ...
  protected DeltaListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  public net.sourceforge.czt.oz.ast.DeltaList getName()
  {
    return this;
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.DeltaListVisitor) {
      net.sourceforge.czt.oz.visitor.DeltaListVisitor<R> visitor = 
      		(net.sourceforge.czt.oz.visitor.DeltaListVisitor<R>) v;
