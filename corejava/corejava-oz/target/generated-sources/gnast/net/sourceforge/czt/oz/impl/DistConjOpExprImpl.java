 ...
 * {@link net.sourceforge.czt.oz.ast.DistConjOpExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class DistConjOpExprImpl
extends 		 		net.sourceforge.czt.oz.impl.DistOpExprImpl
 	  implements net.sourceforge.czt.oz.ast.DistConjOpExpr
{
  ...
  /**
   * static instance count for DistConjOpExprImpl
   */
   ...
   * this instance of DistConjOpExprImpl (e.g., ic >= sl)
   */
  ...
  protected DistConjOpExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.DistConjOpExprVisitor) {
      net.sourceforge.czt.oz.visitor.DistConjOpExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.DistConjOpExprVisitor<R>) v;
