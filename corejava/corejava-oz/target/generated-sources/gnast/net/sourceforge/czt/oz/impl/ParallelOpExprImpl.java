 ...
 * {@link net.sourceforge.czt.oz.ast.ParallelOpExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ParallelOpExprImpl
extends 		 		net.sourceforge.czt.oz.impl.OpExpr2Impl
 	  implements net.sourceforge.czt.oz.ast.ParallelOpExpr
{
  ...
  /**
   * static instance count for ParallelOpExprImpl
   */
   ...
   * this instance of ParallelOpExprImpl (e.g., ic >= sl)
   */
  ...
  protected ParallelOpExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.ParallelOpExprVisitor) {
      net.sourceforge.czt.oz.visitor.ParallelOpExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.ParallelOpExprVisitor<R>) v;
