 ...
 * {@link net.sourceforge.czt.oz.ast.OpPromotionExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class OpPromotionExprImpl
extends 		 		net.sourceforge.czt.oz.impl.OpExprImpl
 	  implements net.sourceforge.czt.oz.ast.OpPromotionExpr
{
  ...
  /**
   * static instance count for OpPromotionExprImpl
   */
   ...
   * this instance of OpPromotionExprImpl (e.g., ic >= sl)
   */
  ...
  protected OpPromotionExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (expr_ != null) {
          if (!expr_.equals(((OpPromotionExprImpl) obj).expr_)) {
            return false;
          }
        }
        else {
          if (((OpPromotionExprImpl) obj).expr_ != null) {
            return false;
          }
        }
        if (name_ != null) {
          if (!name_.equals(((OpPromotionExprImpl) obj).name_)) {
            return false;
          }
        }
        else {
          if (((OpPromotionExprImpl) obj).name_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.OpPromotionExprVisitor) {
      net.sourceforge.czt.oz.visitor.OpPromotionExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.OpPromotionExprVisitor<R>) v;
