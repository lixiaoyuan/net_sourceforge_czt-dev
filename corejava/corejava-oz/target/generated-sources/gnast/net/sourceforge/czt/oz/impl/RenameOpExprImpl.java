 ...
 * {@link net.sourceforge.czt.oz.ast.RenameOpExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class RenameOpExprImpl
extends 		 		net.sourceforge.czt.oz.impl.OpExprImpl
 	  implements net.sourceforge.czt.oz.ast.RenameOpExpr
{
  ...
  /**
   * static instance count for RenameOpExprImpl
   */
   ...
   * this instance of RenameOpExprImpl (e.g., ic >= sl)
   */
  ...
  protected RenameOpExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (opExpr_ != null) {
          if (!opExpr_.equals(((RenameOpExprImpl) obj).opExpr_)) {
            return false;
          }
        }
        else {
          if (((RenameOpExprImpl) obj).opExpr_ != null) {
            return false;
          }
        }
        if (renameList_ != null) {
          if (!renameList_.equals(((RenameOpExprImpl) obj).renameList_)) {
            return false;
          }
        }
        else {
          if (((RenameOpExprImpl) obj).renameList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.RenameOpExprVisitor) {
      net.sourceforge.czt.oz.visitor.RenameOpExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.RenameOpExprVisitor<R>) v;
