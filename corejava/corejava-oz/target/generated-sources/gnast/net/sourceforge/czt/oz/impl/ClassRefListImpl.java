 ...
 * {@link net.sourceforge.czt.oz.ast.ClassRefList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.oz.ast.ClassRef + net.sourceforge.czt.oz.ast

public class ClassRefListImpl
  extends java.util.AbstractList<net.sourceforge.czt.oz.ast.ClassRef>
  implements net.sourceforge.czt.oz.ast.ClassRefList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.oz.ast.ClassRef> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ClassRefListImpl
   */
   ...
   * this instance of ClassRefListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected ClassRefListImpl()
  {
    this(null);
  }

  protected ClassRefListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.oz.ast.ClassRef> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.oz.ast.ClassRef>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.oz.ast.ClassRefList getClassRef()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.oz.ast.ClassRef element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.oz.ast.ClassRef get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.oz.ast.ClassRef remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.oz.ast.ClassRef set(int index, net.sourceforge.czt.oz.ast.ClassRef element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.ClassRefListVisitor) {
      net.sourceforge.czt.oz.visitor.ClassRefListVisitor<R> visitor = 
      		(net.sourceforge.czt.oz.visitor.ClassRefListVisitor<R>) v;
      return visitor.visitClassRefList(this);
    }
  ...
  @Override
  public ClassRefListImpl create(Object[] args)
  {
    ClassRefListImpl result = new ClassRefListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.oz.ast.ClassRef) args[i]);
    }
    return result;
  }
}
