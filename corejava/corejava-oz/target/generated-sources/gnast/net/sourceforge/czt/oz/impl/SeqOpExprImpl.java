 ...
 * {@link net.sourceforge.czt.oz.ast.SeqOpExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SeqOpExprImpl
extends 		 		net.sourceforge.czt.oz.impl.OpExpr2Impl
 	  implements net.sourceforge.czt.oz.ast.SeqOpExpr
{
  ...
  /**
   * static instance count for SeqOpExprImpl
   */
   ...
   * this instance of SeqOpExprImpl (e.g., ic >= sl)
   */
  ...
  protected SeqOpExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.SeqOpExprVisitor) {
      net.sourceforge.czt.oz.visitor.SeqOpExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.SeqOpExprVisitor<R>) v;
