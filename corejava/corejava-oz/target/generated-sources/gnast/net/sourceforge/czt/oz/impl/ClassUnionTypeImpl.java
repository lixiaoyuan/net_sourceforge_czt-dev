 ...
 * {@link net.sourceforge.czt.oz.ast.ClassUnionType}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ClassUnionTypeImpl
extends 		 		net.sourceforge.czt.oz.impl.ClassTypeImpl
 	  implements net.sourceforge.czt.oz.ast.ClassUnionType
{
  ...
  /**
   * static instance count for ClassUnionTypeImpl
   */
   ...
   * this instance of ClassUnionTypeImpl (e.g., ic >= sl)
   */
  ...
  protected ClassUnionTypeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.ClassUnionTypeVisitor) {
      net.sourceforge.czt.oz.visitor.ClassUnionTypeVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.ClassUnionTypeVisitor<R>) v;
