 ...
 * {@link net.sourceforge.czt.oz.ast.PrimaryDecl}.
 *
 * @author GnAST version 1.6-cdh
 */
public class PrimaryDeclImpl
extends   		net.sourceforge.czt.base.impl.TermImpl
	  implements net.sourceforge.czt.oz.ast.PrimaryDecl
{
  ...
  /**
   * static instance count for PrimaryDeclImpl
   */
   ...
   * this instance of PrimaryDeclImpl (e.g., ic >= sl)
   */
  ...
  protected PrimaryDeclImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (declList_ != null) {
          if (!declList_.equals(((PrimaryDeclImpl) obj).declList_)) {
            return false;
          }
        }
        else {
          if (((PrimaryDeclImpl) obj).declList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.PrimaryDeclVisitor) {
      net.sourceforge.czt.oz.visitor.PrimaryDeclVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.PrimaryDeclVisitor<R>) v;
