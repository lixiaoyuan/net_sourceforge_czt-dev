 ...
 * {@link net.sourceforge.czt.oz.ast.ScopeEnrichOpExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ScopeEnrichOpExprImpl
extends 		 		net.sourceforge.czt.oz.impl.OpExpr2Impl
 	  implements net.sourceforge.czt.oz.ast.ScopeEnrichOpExpr
{
  ...
  /**
   * static instance count for ScopeEnrichOpExprImpl
   */
   ...
   * this instance of ScopeEnrichOpExprImpl (e.g., ic >= sl)
   */
  ...
  protected ScopeEnrichOpExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.ScopeEnrichOpExprVisitor) {
      net.sourceforge.czt.oz.visitor.ScopeEnrichOpExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.ScopeEnrichOpExprVisitor<R>) v;
