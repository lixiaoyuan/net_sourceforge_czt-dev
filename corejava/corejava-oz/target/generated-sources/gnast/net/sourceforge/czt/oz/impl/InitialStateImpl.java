 ...
 * {@link net.sourceforge.czt.oz.ast.InitialState}.
 *
 * @author GnAST version 1.6-cdh
 */
public class InitialStateImpl
extends   		net.sourceforge.czt.base.impl.TermImpl
	  implements net.sourceforge.czt.oz.ast.InitialState
{
  ...
  /**
   * static instance count for InitialStateImpl
   */
   ...
   * this instance of InitialStateImpl (e.g., ic >= sl)
   */
  ...
  protected InitialStateImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (pred_ != null) {
          if (!pred_.equals(((InitialStateImpl) obj).pred_)) {
            return false;
          }
        }
        else {
          if (((InitialStateImpl) obj).pred_ != null) {
            return false;
          }
        }
        if (box_ != null) {
          if (!box_.equals(((InitialStateImpl) obj).box_)) {
            return false;
          }
        }
        else {
          if (((InitialStateImpl) obj).box_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.InitialStateVisitor) {
      net.sourceforge.czt.oz.visitor.InitialStateVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.InitialStateVisitor<R>) v;
  ...
  public InitialStateImpl create(Object[] args)
  {
    ...
    try {
						...
						net.sourceforge.czt.z.ast.Box) args[1];
