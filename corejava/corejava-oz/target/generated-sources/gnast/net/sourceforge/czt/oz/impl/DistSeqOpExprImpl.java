 ...
 * {@link net.sourceforge.czt.oz.ast.DistSeqOpExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class DistSeqOpExprImpl
extends 		 		net.sourceforge.czt.oz.impl.DistOpExprImpl
 	  implements net.sourceforge.czt.oz.ast.DistSeqOpExpr
{
  ...
  /**
   * static instance count for DistSeqOpExprImpl
   */
   ...
   * this instance of DistSeqOpExprImpl (e.g., ic >= sl)
   */
  ...
  protected DistSeqOpExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.oz.visitor.DistSeqOpExprVisitor) {
      net.sourceforge.czt.oz.visitor.DistSeqOpExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.oz.visitor.DistSeqOpExprVisitor<R>) v;
