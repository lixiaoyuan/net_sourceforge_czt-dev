 ...
 */
public interface ProofCommandListVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) ProofCommandList.
   * @param  term the ProofCommandList to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitProofCommandList(ProofCommandList term);
}
