 ...
 */
public interface InstantiationListVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) InstantiationList.
   * @param  term the InstantiationList to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitInstantiationList(InstantiationList term);
}
