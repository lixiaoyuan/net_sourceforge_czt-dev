 ...
 * {@link net.sourceforge.czt.zeves.ast.ProofCommandInfoList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.zeves.ast.ProofCommandInfo + net.sourceforge.czt.zeves.ast

public class ProofCommandInfoListImpl
  extends java.util.AbstractList<net.sourceforge.czt.zeves.ast.ProofCommandInfo>
  implements net.sourceforge.czt.zeves.ast.ProofCommandInfoList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.zeves.ast.ProofCommandInfo> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ProofCommandInfoListImpl
   */
   ...
   * this instance of ProofCommandInfoListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected ProofCommandInfoListImpl()
  {
    this(null);
  }

  protected ProofCommandInfoListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.zeves.ast.ProofCommandInfo> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.zeves.ast.ProofCommandInfo>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.zeves.ast.ProofCommandInfoList getProofCommandInfo()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.zeves.ast.ProofCommandInfo element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.ProofCommandInfo get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.ProofCommandInfo remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.ProofCommandInfo set(int index, net.sourceforge.czt.zeves.ast.ProofCommandInfo element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.zeves.visitor.ProofCommandInfoListVisitor) {
      net.sourceforge.czt.zeves.visitor.ProofCommandInfoListVisitor<R> visitor = 
      		(net.sourceforge.czt.zeves.visitor.ProofCommandInfoListVisitor<R>) v;
      return visitor.visitProofCommandInfoList(this);
    }
  ...
  @Override
  public ProofCommandInfoListImpl create(Object[] args)
  {
    ProofCommandInfoListImpl result = new ProofCommandInfoListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.zeves.ast.ProofCommandInfo) args[i]);
    }
    return result;
  }
}
