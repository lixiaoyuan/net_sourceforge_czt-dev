...
public interface NormalizationCommand extends 		 		net.sourceforge.czt.zeves.ast.WrappedCommand
 			{

  /**
   * Returns the NormalizationKind element.
   *
   * @return the NormalizationKind element.
   */
  NormalizationKind getNormalizationKind();


  /**
   * Sets the NormalizationKind element.
   *
   * @param normalizationKind   the NormalizationKind element.
   * @see #getNormalizationKind
   */
  void setNormalizationKind(NormalizationKind normalizationKind);
}
