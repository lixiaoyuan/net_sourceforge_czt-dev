 ...
 */
public interface SimplificationCommandVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) SimplificationCommand.
   * @param  term the SimplificationCommand to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitSimplificationCommand(SimplificationCommand term);
}
