 ...
 * {@link net.sourceforge.czt.zeves.ast.ApplyCommand}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ApplyCommandImpl
extends 		 		net.sourceforge.czt.zeves.impl.ComplexCommandImpl
 	  implements net.sourceforge.czt.zeves.ast.ApplyCommand
{
  ...
  /**
   * static instance count for ApplyCommandImpl
   */
  ...
  protected ApplyCommandImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
   ...
   * also a(n) ApplyCommandImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        //ApplyCommandImpl object = ((ApplyCommandImpl) obj);
        return true;
      }
    }
    return false;
  ...
  public int hashCode()
  {
    ...
    hashCode += "ApplyCommandImpl".hashCode();
    return hashCode;
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.zeves.visitor.ApplyCommandVisitor) {
      net.sourceforge.czt.zeves.visitor.ApplyCommandVisitor<R> visitor = 
      	  (net.sourceforge.czt.zeves.visitor.ApplyCommandVisitor<R>) v;
      return visitor.visitApplyCommand(this);
    }
   ...
   */
  public ApplyCommandImpl create(Object[] args)
  {
    ApplyCommandImpl zedObject = null;
    try {
	        ...
	        zedObject = new ApplyCommandImpl(getFactory());
  ...
  {
    Object[] erg = { getProofStep(), getProofCommand(), getNameList(), getExpr(), getPred() };
    return erg;
  }
