 ...
 */
public interface NormalizationCommandVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) NormalizationCommand.
   * @param  term the NormalizationCommand to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitNormalizationCommand(NormalizationCommand term);
}
