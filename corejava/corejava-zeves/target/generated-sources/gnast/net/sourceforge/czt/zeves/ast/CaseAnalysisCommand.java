...
public interface CaseAnalysisCommand extends 		 		net.sourceforge.czt.zeves.ast.ProofCommand
 			{
   ...
   *
   * @return the CaseAnalysisKind element.
   */
  CaseAnalysisKind getCaseAnalysisKind();


  /**
   * Sets the CaseAnalysisKind element.
   *
   * @param caseAnalysisKind   the CaseAnalysisKind element.
   * @see #getCaseAnalysisKind
   */
  void setCaseAnalysisKind(CaseAnalysisKind caseAnalysisKind);
}
