 ...
 */
public interface ProofCommandInfoVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) ProofCommandInfo.
   * @param  term the ProofCommandInfo to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitProofCommandInfo(ProofCommandInfo term);
}
