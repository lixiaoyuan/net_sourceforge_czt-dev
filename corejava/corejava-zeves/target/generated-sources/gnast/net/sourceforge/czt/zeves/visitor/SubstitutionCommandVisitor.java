 ...
 */
public interface SubstitutionCommandVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) SubstitutionCommand.
   * @param  term the SubstitutionCommand to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitSubstitutionCommand(SubstitutionCommand term);
}
