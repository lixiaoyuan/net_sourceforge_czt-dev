 ...
 */
public interface QuantifiersCommandVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) QuantifiersCommand.
   * @param  term the QuantifiersCommand to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitQuantifiersCommand(QuantifiersCommand term);
}
