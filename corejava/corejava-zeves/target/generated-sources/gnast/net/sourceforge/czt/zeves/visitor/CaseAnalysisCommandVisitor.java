 ...
 */
public interface CaseAnalysisCommandVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) CaseAnalysisCommand.
   * @param  term the CaseAnalysisCommand to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitCaseAnalysisCommand(CaseAnalysisCommand term);
}
