...
public interface ProofScript extends 		 						net.sourceforge.czt.z.ast.Para
			 			{
   ...
   *
   * @return the ProofCommandList element.
   */
  net.sourceforge.czt.zeves.ast.ProofCommandList getProofCommandList();


  /**
   * Sets the ProofCommandList element.
   *
   * @param proofCommandList   the ProofCommandList element.
   * @see #getProofCommandList
   */
  void setProofCommandList(net.sourceforge.czt.zeves.ast.ProofCommandList proofCommandList);
