 ...
 * {@link net.sourceforge.czt.zeves.ast.InstantiationList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.zeves.ast.Instantiation + net.sourceforge.czt.zeves.ast

public class InstantiationListImpl
  extends java.util.AbstractList<net.sourceforge.czt.zeves.ast.Instantiation>
  implements net.sourceforge.czt.zeves.ast.InstantiationList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.zeves.ast.Instantiation> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for InstantiationListImpl
   */
   ...
   * this instance of InstantiationListImpl (e.g., ic >= sl)
   */
  ...
  protected InstantiationListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.zeves.ast.Instantiation> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.zeves.ast.Instantiation>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.zeves.ast.InstantiationList getInstantiation()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.zeves.ast.Instantiation element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.Instantiation get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.Instantiation remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.Instantiation set(int index, net.sourceforge.czt.zeves.ast.Instantiation element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.zeves.visitor.InstantiationListVisitor) {
      net.sourceforge.czt.zeves.visitor.InstantiationListVisitor<R> visitor = 
      		(net.sourceforge.czt.zeves.visitor.InstantiationListVisitor<R>) v;
      return visitor.visitInstantiationList(this);
    }
  ...
  @Override
  public InstantiationListImpl create(Object[] args)
  {
    InstantiationListImpl result = new InstantiationListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.zeves.ast.Instantiation) args[i]);
    }
    return result;
  }
}
