 ...
 * {@link net.sourceforge.czt.zeves.ast.ProofCommandList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.zeves.ast.ProofCommand + net.sourceforge.czt.zeves.ast

public class ProofCommandListImpl
  extends java.util.AbstractList<net.sourceforge.czt.zeves.ast.ProofCommand>
  implements net.sourceforge.czt.zeves.ast.ProofCommandList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.zeves.ast.ProofCommand> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ProofCommandListImpl
   */
   ...
   * this instance of ProofCommandListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected ProofCommandListImpl()
  {
    this(null);
  }

  protected ProofCommandListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.zeves.ast.ProofCommand> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.zeves.ast.ProofCommand>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.zeves.ast.ProofCommandList getProofCommand()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.zeves.ast.ProofCommand element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.ProofCommand get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.ProofCommand remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.zeves.ast.ProofCommand set(int index, net.sourceforge.czt.zeves.ast.ProofCommand element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.zeves.visitor.ProofCommandListVisitor) {
      net.sourceforge.czt.zeves.visitor.ProofCommandListVisitor<R> visitor = 
      		(net.sourceforge.czt.zeves.visitor.ProofCommandListVisitor<R>) v;
      return visitor.visitProofCommandList(this);
    }
  ...
  @Override
  public ProofCommandListImpl create(Object[] args)
  {
    ProofCommandListImpl result = new ProofCommandListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.zeves.ast.ProofCommand) args[i]);
    }
    return result;
  }
}
