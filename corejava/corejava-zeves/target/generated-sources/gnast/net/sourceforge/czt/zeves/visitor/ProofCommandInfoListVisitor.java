 ...
 */
public interface ProofCommandInfoListVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) ProofCommandInfoList.
   * @param  term the ProofCommandInfoList to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitProofCommandInfoList(ProofCommandInfoList term);
}
