 ...
 * {@link net.sourceforge.czt.zeves.ast.UseCommand}.
 *
 * @author GnAST version 1.6-cdh
 */
public class UseCommandImpl
extends 		 		net.sourceforge.czt.zeves.impl.InstantiationCommandImpl
 	  implements net.sourceforge.czt.zeves.ast.UseCommand
{
  ...
  /**
   * static instance count for UseCommandImpl
   */
   ...
   */
  protected UseCommandImpl()
  {
    this(null);
  }

  protected UseCommandImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
   ...
   * also a(n) UseCommandImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        //UseCommandImpl object = ((UseCommandImpl) obj);
        if (theoremRef_ != null) {
          if (!theoremRef_.equals(((UseCommandImpl) obj).theoremRef_)) {
            return false;
          }
        }
        else {
          if (((UseCommandImpl) obj).theoremRef_ != null) {
            return false;
          }
        }
        return true;
  ...
  public int hashCode()
  {
    ...
    hashCode += "UseCommandImpl".hashCode();
    if (theoremRef_ != null) {
      hashCode += 31 * theoremRef_.hashCode();
    }
    return hashCode;
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.zeves.visitor.UseCommandVisitor) {
      net.sourceforge.czt.zeves.visitor.UseCommandVisitor<R> visitor = 
      	  (net.sourceforge.czt.zeves.visitor.UseCommandVisitor<R>) v;
   ...
   */
  public UseCommandImpl create(Object[] args)
  {
    UseCommandImpl zedObject = null;
    try {
						...
						net.sourceforge.czt.z.ast.RefExpr) args[2];
	        zedObject = new UseCommandImpl(getFactory());
  ...
  {
    Object[] erg = { getProofStep(), getInstantiationList(), getTheoremRef() };
    return erg;
  }
  ...
  public void setTheoremRef(
		net.sourceforge.czt.z.ast.RefExpr
	theoremRef)
  {
                          theoremRef_ = theoremRef;
    }
}
