...
public interface ZEvesString extends ZString
{
   ...
   */
  String ZPROOFDOLLARCHAR = String.valueOf(ZEvesChar.ZPROOFDOLLARCHAR);

  /**
   * big turnstyle not bold.
   */
  String ZPROOFCHAR = String.valueOf(ZEvesChar.ZPROOFCHAR);

  /**
   * big turnstyle bold.
   */
  String ZPROOFSECTIONCHAR = String.valueOf(ZEvesChar.ZPROOFSECTIONCHAR);

  /**
   * disabled theorem character marker (boxed cross).
   */
  String DISABLEDTHMTAGCHAR = String.valueOf(ZEvesChar.DISABLEDTHMTAGCHAR);

  /**
   * disabled paragraph definition character marker (unboxed cross).
   */
  String DISABLEDDEFTAGCHAR = String.valueOf(ZEvesChar.DISABLEDDEFTAGCHAR);

  /**
   * left label bracket.
   */
  String LLABEL = String.valueOf(ZEvesChar.LLABEL);

  /**
   * right label bracket.
   */
  String RLABEL = String.valueOf(ZEvesChar.RLABEL);

  /**
   * left znote bracket.
   */
  String LZNOTE = String.valueOf(ZEvesChar.LZNOTE);

  /**
   * right znote bracket.
   */
  String RZNOTE = String.valueOf(ZEvesChar.RZNOTE);

  /**
   * left bag display bracket.
   */
  String LBAG = String.valueOf(ZEvesChar.LBAG);

  /**
   * right bag display bracket.
   */
  String RBAG = String.valueOf(ZEvesChar.RBAG);

  /**
   * bag count.
   */
  String BCOUNT = String.valueOf(ZEvesChar.BCOUNT);

  /**
   * bag scalling.
   */
  String OTIMES = String.valueOf(ZEvesChar.OTIMES);

  /**
   * bag containment.
   */
  String INBAG = String.valueOf(ZEvesChar.INBAG);

  /**
   * bag subset equal.
   */
  String SUBBAGEQ = String.valueOf(ZEvesChar.SUBBAGEQ);

  /**
   * bag union.
   */
  String UPLUS = String.valueOf(ZEvesChar.UPLUS);

  /**
   * bag difference.
   */
  String UMINUS = String.valueOf(ZEvesChar.UMINUS);
