...
public interface CircusJokers extends 		 						net.sourceforge.czt.z.ast.Para
									 			{
  ...
  /**
   * Returns the CircusJokerType element.
   *
   * @return the CircusJokerType element.
   */
  CircusJokerType getCircusJokerType();


  /**
   * Sets the CircusJokerType element.
   *
   * @param circusJokerType   the CircusJokerType element.
   * @see #getCircusJokerType
   */
  void setCircusJokerType(CircusJokerType circusJokerType);
}
