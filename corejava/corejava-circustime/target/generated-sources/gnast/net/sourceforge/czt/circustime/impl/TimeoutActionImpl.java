 ...
 * {@link net.sourceforge.czt.circustime.ast.TimeoutAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class TimeoutActionImpl
extends 		 		net.sourceforge.czt.circustime.impl.ActionTime2Impl
 	  implements net.sourceforge.czt.circustime.ast.TimeoutAction
{
  ...
  /**
   * static instance count for TimeoutActionImpl
   */
   ...
   * this instance of TimeoutActionImpl (e.g., ic >= sl)
   */
  ...
  protected TimeoutActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  /**
   * Compares the specified object with this TimeoutActionImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) TimeoutActionImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        //TimeoutActionImpl object = ((TimeoutActionImpl) obj);
        return true;
      }
    }
    return false;
  ...
  /**
   * Returns the hash code value for this TimeoutActionImpl.
   */
  @Override
  public int hashCode()
  {
    ...
    hashCode += "TimeoutActionImpl".hashCode();
    return hashCode;
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.circustime.visitor.TimeoutActionVisitor) {
      net.sourceforge.czt.circustime.visitor.TimeoutActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circustime.visitor.TimeoutActionVisitor<R>) v;
      return visitor.visitTimeoutAction(this);
    }
   ...
   */
  public TimeoutActionImpl create(Object[] args)
  {
    TimeoutActionImpl zedObject = null;
    try {
	  	...
	  	circusAction = (java.util.List<net.sourceforge.czt.circus.ast.CircusAction>) args[0];
	        ...
	        zedObject = new TimeoutActionImpl(getFactory());
