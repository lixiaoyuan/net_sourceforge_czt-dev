...
public interface CircusString extends ZPattString
{
   ...
   */
  String CIRCUSCHAR = String.valueOf(CircusChar.CIRCUSCHAR);

  /**
   * box drawings thin horizontal line to the right..
   */
  String CIRCUSACTIONCHAR = String.valueOf(CircusChar.CIRCUSACTIONCHAR);

  /**
   * refinement.
   */
  String CIRCREFINES = String.valueOf(CircusChar.CIRCREFINES);

  /**
   * simulation.
   */
  String CIRCSIMULATES = String.valueOf(CircusChar.CIRCSIMULATES);
   ...
   */
  String CIRCSPOT = String.valueOf(CircusChar.CIRCSPOT);
   ...
   * interrupt operator.
   */
  String CIRCINTERRUPT = String.valueOf(CircusChar.CIRCINTERRUPT);
   ...
   */
  String UNIVERSE = String.valueOf(CircusChar.UNIVERSE);
