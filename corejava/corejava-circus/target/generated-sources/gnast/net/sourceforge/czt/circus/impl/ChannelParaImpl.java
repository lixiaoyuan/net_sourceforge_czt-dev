 ...
 * {@link net.sourceforge.czt.circus.ast.ChannelPara}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ChannelParaImpl
extends 		 						net.sourceforge.czt.z.impl.ParaImpl
						 	  implements net.sourceforge.czt.circus.ast.ChannelPara
{
  ...
  /**
   * static instance count for ChannelParaImpl
   */
   ...
   * this instance of ChannelParaImpl (e.g., ic >= sl)
   */
  ...
  protected ChannelParaImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (declList_ != null) {
          if (!declList_.equals(((ChannelParaImpl) obj).declList_)) {
            return false;
          }
        }
        else {
          if (((ChannelParaImpl) obj).declList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.ChannelParaVisitor) {
      net.sourceforge.czt.circus.visitor.ChannelParaVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.ChannelParaVisitor<R>) v;
