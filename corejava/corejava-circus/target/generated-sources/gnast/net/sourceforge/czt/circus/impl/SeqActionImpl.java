 ...
 * {@link net.sourceforge.czt.circus.ast.SeqAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SeqActionImpl
extends 		 		net.sourceforge.czt.circus.impl.Action2Impl
 	  implements net.sourceforge.czt.circus.ast.SeqAction
{
  ...
  /**
   * static instance count for SeqActionImpl
   */
   ...
   * this instance of SeqActionImpl (e.g., ic >= sl)
   */
  ...
  protected SeqActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.SeqActionVisitor) {
      net.sourceforge.czt.circus.visitor.SeqActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.SeqActionVisitor<R>) v;
