 ...
 * {@link net.sourceforge.czt.circus.ast.BasicChannelSetExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class BasicChannelSetExprImpl
extends 		 						net.sourceforge.czt.z.impl.ExprImpl
						 	  implements net.sourceforge.czt.circus.ast.BasicChannelSetExpr
{
  ...
  /**
   * static instance count for BasicChannelSetExprImpl
   */
   ...
   * this instance of BasicChannelSetExprImpl (e.g., ic >= sl)
   */
  ...
  protected BasicChannelSetExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
    ...
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (communicationList_ != null) {
          if (!communicationList_.equals(((BasicChannelSetExprImpl) obj).communicationList_)) {
            return false;
          }
        }
        else {
          if (((BasicChannelSetExprImpl) obj).communicationList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.BasicChannelSetExprVisitor) {
      net.sourceforge.czt.circus.visitor.BasicChannelSetExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.BasicChannelSetExprVisitor<R>) v;
  ...
  public BasicChannelSetExprImpl create(Object[] args)
  {
    ...
    try {
						...
						net.sourceforge.czt.circus.ast.CommunicationList) args[0];
  ...
  {
    Object[] erg = { getCommunicationList() };
    return erg;
  }
