 ...
 * {@link net.sourceforge.czt.circus.ast.GuardedAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class GuardedActionImpl
extends 		 		net.sourceforge.czt.circus.impl.Action1Impl
 	  implements net.sourceforge.czt.circus.ast.GuardedAction
{
  ...
  /**
   * static instance count for GuardedActionImpl
   */
   ...
   * this instance of GuardedActionImpl (e.g., ic >= sl)
   */
  ...
  protected GuardedActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (pred_ != null) {
          if (!pred_.equals(((GuardedActionImpl) obj).pred_)) {
            return false;
          }
        }
        else {
          if (((GuardedActionImpl) obj).pred_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.GuardedActionVisitor) {
      net.sourceforge.czt.circus.visitor.GuardedActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.GuardedActionVisitor<R>) v;
