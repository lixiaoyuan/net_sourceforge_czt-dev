 ...
 * {@link net.sourceforge.czt.circus.ast.PrefixingAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class PrefixingActionImpl
extends 		 		net.sourceforge.czt.circus.impl.Action1Impl
 	  implements net.sourceforge.czt.circus.ast.PrefixingAction
{
  ...
  /**
   * static instance count for PrefixingActionImpl
   */
   ...
   * this instance of PrefixingActionImpl (e.g., ic >= sl)
   */
  ...
  protected PrefixingActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
    ...
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (communication_ != null) {
          if (!communication_.equals(((PrefixingActionImpl) obj).communication_)) {
            return false;
          }
        }
        else {
          if (((PrefixingActionImpl) obj).communication_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.PrefixingActionVisitor) {
      net.sourceforge.czt.circus.visitor.PrefixingActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.PrefixingActionVisitor<R>) v;
