...
/**
 * A(n) CircusGuardedCommand visitor.
 */
public interface CircusGuardedCommandVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) CircusGuardedCommand.
   * @param  term the CircusGuardedCommand to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitCircusGuardedCommand(CircusGuardedCommand term);
}
