 ...
 * {@link net.sourceforge.czt.circus.ast.SeqProcessIdx}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SeqProcessIdxImpl
extends 		 		net.sourceforge.czt.circus.impl.ProcessIdxImpl
 	  implements net.sourceforge.czt.circus.ast.SeqProcessIdx
{
  ...
  /**
   * static instance count for SeqProcessIdxImpl
   */
   ...
   * this instance of SeqProcessIdxImpl (e.g., ic >= sl)
   */
  ...
  protected SeqProcessIdxImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.SeqProcessIdxVisitor) {
      net.sourceforge.czt.circus.visitor.SeqProcessIdxVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.SeqProcessIdxVisitor<R>) v;
