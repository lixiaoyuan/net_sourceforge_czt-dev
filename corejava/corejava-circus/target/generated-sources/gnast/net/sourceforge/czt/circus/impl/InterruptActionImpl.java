 ...
 * {@link net.sourceforge.czt.circus.ast.InterruptAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class InterruptActionImpl
extends 		 		net.sourceforge.czt.circus.impl.Action2Impl
 	  implements net.sourceforge.czt.circus.ast.InterruptAction
{
  ...
  /**
   * static instance count for InterruptActionImpl
   */
   ...
   * this instance of InterruptActionImpl (e.g., ic >= sl)
   */
  ...
  protected InterruptActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  /**
   * Compares the specified object with this InterruptActionImpl
   * for equality.  Returns true if and only if the specified object is
   * also a(n) InterruptActionImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        //InterruptActionImpl object = ((InterruptActionImpl) obj);
        return true;
      }
    }
    return false;
  ...
  /**
   * Returns the hash code value for this InterruptActionImpl.
   */
  @Override
  public int hashCode()
  {
    ...
    hashCode += "InterruptActionImpl".hashCode();
    return hashCode;
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.InterruptActionVisitor) {
      net.sourceforge.czt.circus.visitor.InterruptActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.InterruptActionVisitor<R>) v;
      return visitor.visitInterruptAction(this);
    }
   ...
   */
  public InterruptActionImpl create(Object[] args)
  {
    InterruptActionImpl zedObject = null;
    try {
	  	...
	  	circusAction = (java.util.List<net.sourceforge.czt.circus.ast.CircusAction>) args[0];
	        zedObject = new InterruptActionImpl(getFactory());
