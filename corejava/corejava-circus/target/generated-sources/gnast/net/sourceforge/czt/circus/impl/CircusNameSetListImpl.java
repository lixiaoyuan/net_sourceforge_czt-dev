 ...
 * {@link net.sourceforge.czt.circus.ast.CircusNameSetList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.circus.ast.NameSet + net.sourceforge.czt.circus.ast

public class CircusNameSetListImpl
  extends java.util.AbstractList<net.sourceforge.czt.circus.ast.NameSet>
  implements net.sourceforge.czt.circus.ast.CircusNameSetList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.circus.ast.NameSet> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for CircusNameSetListImpl
   */
   ...
   * this instance of CircusNameSetListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected CircusNameSetListImpl()
  {
    this(null);
  }

  protected CircusNameSetListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.circus.ast.NameSet> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.circus.ast.NameSet>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.circus.ast.CircusNameSetList getNameSet()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.circus.ast.NameSet element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.NameSet get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.NameSet remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.NameSet set(int index, net.sourceforge.czt.circus.ast.NameSet element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.CircusNameSetListVisitor) {
      net.sourceforge.czt.circus.visitor.CircusNameSetListVisitor<R> visitor = 
      		(net.sourceforge.czt.circus.visitor.CircusNameSetListVisitor<R>) v;
      return visitor.visitCircusNameSetList(this);
    }
  ...
  @Override
  public CircusNameSetListImpl create(Object[] args)
  {
    CircusNameSetListImpl result = new CircusNameSetListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.circus.ast.NameSet) args[i]);
    }
    return result;
  }
}
