 ...
 * {@link net.sourceforge.czt.circus.ast.CircusNameSet}.
 *
 * @author GnAST version 1.6-cdh
 */
public class CircusNameSetImpl
extends 		 		net.sourceforge.czt.circus.impl.NameSetImpl
 	  implements net.sourceforge.czt.circus.ast.CircusNameSet
{
  ...
  /**
   * static instance count for CircusNameSetImpl
   */
   ...
   */
  protected CircusNameSetImpl()
  {
    this(null);
  }

  protected CircusNameSetImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
   ...
   * also a(n) CircusNameSetImpl and all the getter methods except getAnns
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        //CircusNameSetImpl object = ((CircusNameSetImpl) obj);
        if (expr_ != null) {
          if (!expr_.equals(((CircusNameSetImpl) obj).expr_)) {
            return false;
          }
        }
        else {
          if (((CircusNameSetImpl) obj).expr_ != null) {
            return false;
          }
        }
        return true;
  ...
  public int hashCode()
  {
    ...
    hashCode += "CircusNameSetImpl".hashCode();
    if (expr_ != null) {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.CircusNameSetVisitor) {
      net.sourceforge.czt.circus.visitor.CircusNameSetVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.CircusNameSetVisitor<R>) v;
      return visitor.visitCircusNameSet(this);
    }
   ...
   */
  public CircusNameSetImpl create(Object[] args)
  {
    CircusNameSetImpl zedObject = null;
    try {
	  	  			  	net.sourceforge.czt.z.ast.Expr expr = (
						net.sourceforge.czt.z.ast.Expr) args[0];
	        zedObject = new CircusNameSetImpl(getFactory());
