 ...
 * {@link net.sourceforge.czt.circus.ast.LetVarAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class LetVarActionImpl
extends 		 		net.sourceforge.czt.circus.impl.LetActionImpl
 	  implements net.sourceforge.czt.circus.ast.LetVarAction
{
  ...
  /**
   * static instance count for LetVarActionImpl
   */
  ...
  protected LetVarActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (declList_ != null) {
          if (!declList_.equals(((LetVarActionImpl) obj).declList_)) {
            return false;
          }
        }
        else {
          if (((LetVarActionImpl) obj).declList_ != null) {
            return false;
          }
        }
        if (exprList_ != null) {
          if (!exprList_.equals(((LetVarActionImpl) obj).exprList_)) {
            return false;
          }
        }
        else {
          if (((LetVarActionImpl) obj).exprList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.LetVarActionVisitor) {
      net.sourceforge.czt.circus.visitor.LetVarActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.LetVarActionVisitor<R>) v;
  ...
  public LetVarActionImpl create(Object[] args)
  {
    ...
    try {
						...
						net.sourceforge.czt.z.ast.ExprList) args[2];
