 ...
 * {@link net.sourceforge.czt.circus.ast.IntChoiceProcessIte}.
 *
 * @author GnAST version 1.6-cdh
 */
public class IntChoiceProcessIteImpl
extends 		 		net.sourceforge.czt.circus.impl.ProcessIteImpl
 	  implements net.sourceforge.czt.circus.ast.IntChoiceProcessIte
{
  ...
  /**
   * static instance count for IntChoiceProcessIteImpl
   */
   ...
   * this instance of IntChoiceProcessIteImpl (e.g., ic >= sl)
   */
  ...
  protected IntChoiceProcessIteImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.IntChoiceProcessIteVisitor) {
      net.sourceforge.czt.circus.visitor.IntChoiceProcessIteVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.IntChoiceProcessIteVisitor<R>) v;
