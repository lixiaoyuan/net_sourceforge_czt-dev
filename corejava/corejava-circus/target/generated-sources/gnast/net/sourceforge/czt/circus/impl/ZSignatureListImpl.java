 ...
 * {@link net.sourceforge.czt.circus.ast.ZSignatureList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Signature + net.sourceforge.czt.z.ast

public class ZSignatureListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Signature>
  implements net.sourceforge.czt.circus.ast.ZSignatureList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Signature> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZSignatureListImpl
   */
   ...
   * this instance of ZSignatureListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected ZSignatureListImpl()
  {
    this(null);
  }

  protected ZSignatureListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Signature> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Signature>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.circus.ast.ZSignatureList getSignature()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Signature element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Signature get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Signature remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Signature set(int index, net.sourceforge.czt.z.ast.Signature element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.ZSignatureListVisitor) {
      net.sourceforge.czt.circus.visitor.ZSignatureListVisitor<R> visitor = 
      		(net.sourceforge.czt.circus.visitor.ZSignatureListVisitor<R>) v;
      return visitor.visitZSignatureList(this);
    }
  ...
  @Override
  public ZSignatureListImpl create(Object[] args)
  {
    ZSignatureListImpl result = new ZSignatureListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Signature) args[i]);
    }
    return result;
  }
}
