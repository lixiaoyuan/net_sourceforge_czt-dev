 ...
 * {@link net.sourceforge.czt.circus.ast.ParamAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ParamActionImpl
extends 		 		net.sourceforge.czt.circus.impl.ActionDImpl
 	  implements net.sourceforge.czt.circus.ast.ParamAction
{
  ...
  /**
   * static instance count for ParamActionImpl
   */
  ...
  protected ParamActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.ParamActionVisitor) {
      net.sourceforge.czt.circus.visitor.ParamActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.ParamActionVisitor<R>) v;
