...
/**
 * A(n) ActionTransformerPred visitor.
 */
public interface ActionTransformerPredVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) ActionTransformerPred.
   * @param  term the ActionTransformerPred to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitActionTransformerPred(ActionTransformerPred term);
}
