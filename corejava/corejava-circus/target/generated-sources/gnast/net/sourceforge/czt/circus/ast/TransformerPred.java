...
public interface TransformerPred extends 		 						net.sourceforge.czt.z.ast.Pred
						 			{
   ...
   *
   * @return the Transformation element.
   */
   ...
   *
   * @param transformation   the Transformation element.
