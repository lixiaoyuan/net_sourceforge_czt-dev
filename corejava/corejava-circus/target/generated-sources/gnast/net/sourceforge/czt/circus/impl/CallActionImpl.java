 ...
 * {@link net.sourceforge.czt.circus.ast.CallAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class CallActionImpl
extends 		 		net.sourceforge.czt.circus.impl.CircusActionImpl
 	  implements net.sourceforge.czt.circus.ast.CallAction
{
  ...
  /**
   * static instance count for CallActionImpl
   */
  ...
  protected CallActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (name_ != null) {
          if (!name_.equals(((CallActionImpl) obj).name_)) {
            return false;
          }
        }
        else {
          if (((CallActionImpl) obj).name_ != null) {
            return false;
          }
        }
        if (exprList_ != null) {
          if (!exprList_.equals(((CallActionImpl) obj).exprList_)) {
            return false;
          }
        }
        else {
          if (((CallActionImpl) obj).exprList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.CallActionVisitor) {
      net.sourceforge.czt.circus.visitor.CallActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.CallActionVisitor<R>) v;
  ...
  {
    Object[] erg = { getName(), getExprList() };
    return erg;
  }
