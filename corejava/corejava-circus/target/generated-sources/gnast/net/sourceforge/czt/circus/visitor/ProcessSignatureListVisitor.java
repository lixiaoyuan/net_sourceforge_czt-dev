...
/**
 * A(n) ProcessSignatureList visitor.
 */
public interface ProcessSignatureListVisitor<R> extends Visitor<R>
{
  /**
   * Visits a(n) ProcessSignatureList.
   * @param  term the ProcessSignatureList to be visited.
   * @return some kind of <code>Object</code>.
   */
  R visitProcessSignatureList(ProcessSignatureList term);
}
