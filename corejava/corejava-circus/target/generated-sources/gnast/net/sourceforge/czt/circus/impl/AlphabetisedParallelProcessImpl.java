 ...
 * {@link net.sourceforge.czt.circus.ast.AlphabetisedParallelProcess}.
 *
 * @author GnAST version 1.6-cdh
 */
public class AlphabetisedParallelProcessImpl
extends 		 		net.sourceforge.czt.circus.impl.ParProcessImpl
 	  implements net.sourceforge.czt.circus.ast.AlphabetisedParallelProcess
{
  ...
  /**
   * static instance count for AlphabetisedParallelProcessImpl
   */
  ...
  protected AlphabetisedParallelProcessImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (channelSet_ != null) {
          if (!channelSet_.equals(((AlphabetisedParallelProcessImpl) obj).channelSet_)) {
            return false;
          }
        }
        else {
          if (((AlphabetisedParallelProcessImpl) obj).channelSet_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.AlphabetisedParallelProcessVisitor) {
      net.sourceforge.czt.circus.visitor.AlphabetisedParallelProcessVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.AlphabetisedParallelProcessVisitor<R>) v;
  ...
  public AlphabetisedParallelProcessImpl create(Object[] args)
  {
    ...
    try {
	  	...
	  	channelSet = (java.util.List<net.sourceforge.czt.circus.ast.ChannelSet>) args[1];
