 ...
 * {@link net.sourceforge.czt.circus.ast.MuAction}.
 *
 * @author GnAST version 1.6-cdh
 */
public class MuActionImpl
extends 		 		net.sourceforge.czt.circus.impl.Action1Impl
 	  implements net.sourceforge.czt.circus.ast.MuAction
{
  ...
  /**
   * static instance count for MuActionImpl
   */
   ...
   * this instance of MuActionImpl (e.g., ic >= sl)
   */
  ...
  protected MuActionImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (name_ != null) {
          if (!name_.equals(((MuActionImpl) obj).name_)) {
            return false;
          }
        }
        else {
          if (((MuActionImpl) obj).name_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.MuActionVisitor) {
      net.sourceforge.czt.circus.visitor.MuActionVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.MuActionVisitor<R>) v;
  ...
  {
    Object[] erg = { getCircusAction(), getName() };
    return erg;
  }
