 ...
 * {@link net.sourceforge.czt.circus.ast.CircusCommunicationList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.circus.ast.Communication + net.sourceforge.czt.circus.ast

public class CircusCommunicationListImpl
  extends java.util.AbstractList<net.sourceforge.czt.circus.ast.Communication>
  implements net.sourceforge.czt.circus.ast.CircusCommunicationList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.circus.ast.Communication> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for CircusCommunicationListImpl
   */
   ...
   * this instance of CircusCommunicationListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected CircusCommunicationListImpl()
  {
    this(null);
  }

  protected CircusCommunicationListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.circus.ast.Communication> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.circus.ast.Communication>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.circus.ast.Communication element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.Communication get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.Communication remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.Communication set(int index, net.sourceforge.czt.circus.ast.Communication element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.CircusCommunicationListVisitor) {
      net.sourceforge.czt.circus.visitor.CircusCommunicationListVisitor<R> visitor = 
      		(net.sourceforge.czt.circus.visitor.CircusCommunicationListVisitor<R>) v;
      return visitor.visitCircusCommunicationList(this);
    }
  ...
  @Override
  public CircusCommunicationListImpl create(Object[] args)
  {
    CircusCommunicationListImpl result = new CircusCommunicationListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.circus.ast.Communication) args[i]);
    }
    return result;
  }
}
