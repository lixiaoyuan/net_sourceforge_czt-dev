 ...
 * {@link net.sourceforge.czt.circus.ast.CircusFieldList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.circus.ast.Field + net.sourceforge.czt.circus.ast

public class CircusFieldListImpl
  extends java.util.AbstractList<net.sourceforge.czt.circus.ast.Field>
  implements net.sourceforge.czt.circus.ast.CircusFieldList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.circus.ast.Field> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for CircusFieldListImpl
   */
   ...
   * this instance of CircusFieldListImpl (e.g., ic >= sl)
   */
  ...
  protected CircusFieldListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.circus.ast.Field> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.circus.ast.Field>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.circus.ast.CircusFieldList getField()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.circus.ast.Field element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.Field get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.Field remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.Field set(int index, net.sourceforge.czt.circus.ast.Field element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.CircusFieldListVisitor) {
      net.sourceforge.czt.circus.visitor.CircusFieldListVisitor<R> visitor = 
      		(net.sourceforge.czt.circus.visitor.CircusFieldListVisitor<R>) v;
  ...
  public CircusFieldListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.circus.ast.Field) args[i]);
    }
    return result;
  }
}
