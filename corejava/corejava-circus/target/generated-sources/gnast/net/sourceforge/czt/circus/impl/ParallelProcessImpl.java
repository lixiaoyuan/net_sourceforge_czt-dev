 ...
 * {@link net.sourceforge.czt.circus.ast.ParallelProcess}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ParallelProcessImpl
extends 		 		net.sourceforge.czt.circus.impl.ParProcessImpl
 	  implements net.sourceforge.czt.circus.ast.ParallelProcess
{
  ...
  /**
   * static instance count for ParallelProcessImpl
   */
   ...
   * this instance of ParallelProcessImpl (e.g., ic >= sl)
   */
  ...
  protected ParallelProcessImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (channelSet_ != null) {
          if (!channelSet_.equals(((ParallelProcessImpl) obj).channelSet_)) {
            return false;
          }
        }
        else {
          if (((ParallelProcessImpl) obj).channelSet_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.ParallelProcessVisitor) {
      net.sourceforge.czt.circus.visitor.ParallelProcessVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.ParallelProcessVisitor<R>) v;
