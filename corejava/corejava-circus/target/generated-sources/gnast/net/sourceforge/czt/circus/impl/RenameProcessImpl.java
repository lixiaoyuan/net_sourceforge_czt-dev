 ...
 * {@link net.sourceforge.czt.circus.ast.RenameProcess}.
 *
 * @author GnAST version 1.6-cdh
 */
public class RenameProcessImpl
extends 		 		net.sourceforge.czt.circus.impl.Process1Impl
 	  implements net.sourceforge.czt.circus.ast.RenameProcess
{
  ...
  /**
   * static instance count for RenameProcessImpl
   */
  ...
  protected RenameProcessImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
    ...
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (assignmentPairs_ != null) {
          if (!assignmentPairs_.equals(((RenameProcessImpl) obj).assignmentPairs_)) {
            return false;
          }
        }
        else {
          if (((RenameProcessImpl) obj).assignmentPairs_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.RenameProcessVisitor) {
      net.sourceforge.czt.circus.visitor.RenameProcessVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.RenameProcessVisitor<R>) v;
