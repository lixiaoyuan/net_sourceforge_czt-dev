 ...
 * {@link net.sourceforge.czt.circus.ast.NameSetPara}.
 *
 * @author GnAST version 1.6-cdh
 */
public class NameSetParaImpl
extends 		 						net.sourceforge.czt.z.impl.ParaImpl
						 	  implements net.sourceforge.czt.circus.ast.NameSetPara
{
  ...
  /**
   * static instance count for NameSetParaImpl
   */
  ...
  protected NameSetParaImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (name_ != null) {
          if (!name_.equals(((NameSetParaImpl) obj).name_)) {
            return false;
          }
        }
        else {
          if (((NameSetParaImpl) obj).name_ != null) {
            return false;
          }
        }
        if (nameSet_ != null) {
          if (!nameSet_.equals(((NameSetParaImpl) obj).nameSet_)) {
            return false;
          }
        }
        else {
          if (((NameSetParaImpl) obj).nameSet_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.NameSetParaVisitor) {
      net.sourceforge.czt.circus.visitor.NameSetParaVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.NameSetParaVisitor<R>) v;
