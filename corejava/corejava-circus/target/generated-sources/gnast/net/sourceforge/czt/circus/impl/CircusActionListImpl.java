 ...
 * {@link net.sourceforge.czt.circus.ast.CircusActionList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.circus.ast.CircusAction + net.sourceforge.czt.circus.ast

public class CircusActionListImpl
  extends java.util.AbstractList<net.sourceforge.czt.circus.ast.CircusAction>
  implements net.sourceforge.czt.circus.ast.CircusActionList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.circus.ast.CircusAction> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for CircusActionListImpl
   */
   ...
   * this instance of CircusActionListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected CircusActionListImpl()
  {
    this(null);
  }

  protected CircusActionListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.circus.ast.CircusAction> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.circus.ast.CircusAction>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.circus.ast.CircusActionList getCircusAction()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.circus.ast.CircusAction element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.CircusAction get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.CircusAction remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.CircusAction set(int index, net.sourceforge.czt.circus.ast.CircusAction element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.CircusActionListVisitor) {
      net.sourceforge.czt.circus.visitor.CircusActionListVisitor<R> visitor = 
      		(net.sourceforge.czt.circus.visitor.CircusActionListVisitor<R>) v;
      return visitor.visitCircusActionList(this);
    }
  ...
  @Override
  public CircusActionListImpl create(Object[] args)
  {
    CircusActionListImpl result = new CircusActionListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.circus.ast.CircusAction) args[i]);
    }
    return result;
  }
}
