 ...
 * {@link net.sourceforge.czt.circus.ast.ProcessSignatureList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.circus.ast.ProcessSignature + net.sourceforge.czt.circus.ast

public class ProcessSignatureListImpl
  extends java.util.AbstractList<net.sourceforge.czt.circus.ast.ProcessSignature>
  implements net.sourceforge.czt.circus.ast.ProcessSignatureList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.circus.ast.ProcessSignature> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ProcessSignatureListImpl
   */
   ...
   * this instance of ProcessSignatureListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected ProcessSignatureListImpl()
  {
    this(null);
  }

  protected ProcessSignatureListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.circus.ast.ProcessSignature> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.circus.ast.ProcessSignature>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.circus.ast.ProcessSignatureList getProcessSignature()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.circus.ast.ProcessSignature element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.ProcessSignature get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.ProcessSignature remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.ProcessSignature set(int index, net.sourceforge.czt.circus.ast.ProcessSignature element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.ProcessSignatureListVisitor) {
      net.sourceforge.czt.circus.visitor.ProcessSignatureListVisitor<R> visitor = 
      		(net.sourceforge.czt.circus.visitor.ProcessSignatureListVisitor<R>) v;
      return visitor.visitProcessSignatureList(this);
    }
  ...
  @Override
  public ProcessSignatureListImpl create(Object[] args)
  {
    ProcessSignatureListImpl result = new ProcessSignatureListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.circus.ast.ProcessSignature) args[i]);
    }
    return result;
  }
}
