 ...
 * {@link net.sourceforge.czt.circus.ast.SeqProcessIte}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SeqProcessIteImpl
extends 		 		net.sourceforge.czt.circus.impl.ProcessIteImpl
 	  implements net.sourceforge.czt.circus.ast.SeqProcessIte
{
  ...
  /**
   * static instance count for SeqProcessIteImpl
   */
   ...
   * this instance of SeqProcessIteImpl (e.g., ic >= sl)
   */
  ...
  protected SeqProcessIteImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.SeqProcessIteVisitor) {
      net.sourceforge.czt.circus.visitor.SeqProcessIteVisitor<R> visitor = 
      	  (net.sourceforge.czt.circus.visitor.SeqProcessIteVisitor<R>) v;
