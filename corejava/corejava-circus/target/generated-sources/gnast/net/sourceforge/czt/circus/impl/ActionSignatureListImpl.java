 ...
 * {@link net.sourceforge.czt.circus.ast.ActionSignatureList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.circus.ast.ActionSignature + net.sourceforge.czt.circus.ast

public class ActionSignatureListImpl
  extends java.util.AbstractList<net.sourceforge.czt.circus.ast.ActionSignature>
  implements net.sourceforge.czt.circus.ast.ActionSignatureList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.circus.ast.ActionSignature> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ActionSignatureListImpl
   */
   ...
   * this instance of ActionSignatureListImpl (e.g., ic >= sl)
   */
  ...
  protected ActionSignatureListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.circus.ast.ActionSignature> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.circus.ast.ActionSignature>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.circus.ast.ActionSignatureList getActionSignature()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.circus.ast.ActionSignature element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.ActionSignature get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.ActionSignature remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.circus.ast.ActionSignature set(int index, net.sourceforge.czt.circus.ast.ActionSignature element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.circus.visitor.ActionSignatureListVisitor) {
      net.sourceforge.czt.circus.visitor.ActionSignatureListVisitor<R> visitor = 
      		(net.sourceforge.czt.circus.visitor.ActionSignatureListVisitor<R>) v;
      return visitor.visitActionSignatureList(this);
    }
  ...
  @Override
  public ActionSignatureListImpl create(Object[] args)
  {
    ActionSignatureListImpl result = new ActionSignatureListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.circus.ast.ActionSignature) args[i]);
    }
    return result;
  }
}
