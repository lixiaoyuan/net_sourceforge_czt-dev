    ...
    extends SignatureList
{
    ...
    protected List<JAXBElement<ProcessSignature>> processSignature;
     ...
     * 
     */
    public List<JAXBElement<ProcessSignature>> getProcessSignature() {
        if (processSignature == null) {
            processSignature = new ArrayList<JAXBElement<ProcessSignature>>();
        }
