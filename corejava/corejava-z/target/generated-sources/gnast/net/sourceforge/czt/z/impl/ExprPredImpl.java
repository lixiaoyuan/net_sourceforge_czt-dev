 ...
 * {@link net.sourceforge.czt.z.ast.ExprPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ExprPredImpl
extends 		 		net.sourceforge.czt.z.impl.PredImpl
 	  implements net.sourceforge.czt.z.ast.ExprPred
{
  ...
  /**
   * static instance count for ExprPredImpl
   */
   ...
   * this instance of ExprPredImpl (e.g., ic >= sl)
   */
  ...
  protected ExprPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (expr_ != null) {
          if (!expr_.equals(((ExprPredImpl) obj).expr_)) {
            return false;
          }
        }
        else {
          if (((ExprPredImpl) obj).expr_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ExprPredVisitor) {
      net.sourceforge.czt.z.visitor.ExprPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ExprPredVisitor<R>) v;
