 ...
 * {@link net.sourceforge.czt.z.ast.NumStroke}.
 *
 * @author GnAST version 1.6-cdh
 */
public class NumStrokeImpl
extends 		 		net.sourceforge.czt.z.impl.StrokeImpl
 	  implements net.sourceforge.czt.z.ast.NumStroke
{
  ...
  /**
   * static instance count for NumStrokeImpl
   */
   ...
   * this instance of NumStrokeImpl (e.g., ic >= sl)
   */
  ...
  protected NumStrokeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (digit_ != null) {
          if (!digit_.equals(((NumStrokeImpl) obj).digit_)) {
            return false;
          }
        }
        else {
          if (((NumStrokeImpl) obj).digit_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.NumStrokeVisitor) {
      net.sourceforge.czt.z.visitor.NumStrokeVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.NumStrokeVisitor<R>) v;
  ...
  public NumStrokeImpl create(Object[] args)
  {
    ...
    try {
	  	  								  	net.sourceforge.czt.base.ast.Digit digit = (
													net.sourceforge.czt.base.ast.Digit) args[0];
  ...
  private
            					net.sourceforge.czt.base.ast.Digit
  digit_;
