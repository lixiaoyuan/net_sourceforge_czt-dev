 ...
 * {@link net.sourceforge.czt.z.ast.OrExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class OrExprImpl
extends 		 		net.sourceforge.czt.z.impl.SchExpr2Impl
 	  implements net.sourceforge.czt.z.ast.OrExpr
{
  ...
  /**
   * static instance count for OrExprImpl
   */
   ...
   * this instance of OrExprImpl (e.g., ic >= sl)
   */
  ...
  protected OrExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.OrExprVisitor) {
      net.sourceforge.czt.z.visitor.OrExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.OrExprVisitor<R>) v;
