 ...
 * {@link net.sourceforge.czt.z.ast.Exists1Expr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class Exists1ExprImpl
extends 		 		net.sourceforge.czt.z.impl.Qnt1ExprImpl
 	  implements net.sourceforge.czt.z.ast.Exists1Expr
{
  ...
  /**
   * static instance count for Exists1ExprImpl
   */
   ...
   * this instance of Exists1ExprImpl (e.g., ic >= sl)
   */
  ...
  protected Exists1ExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.Exists1ExprVisitor) {
      net.sourceforge.czt.z.visitor.Exists1ExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.Exists1ExprVisitor<R>) v;
