 ...
 * {@link net.sourceforge.czt.z.ast.ConstDecl}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ConstDeclImpl
extends 		 		net.sourceforge.czt.z.impl.DeclImpl
 	  implements net.sourceforge.czt.z.ast.ConstDecl
{
  ...
  /**
   * static instance count for ConstDeclImpl
   */
   ...
   * this instance of ConstDeclImpl (e.g., ic >= sl)
   */
  ...
  protected ConstDeclImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (name_ != null) {
          if (!name_.equals(((ConstDeclImpl) obj).name_)) {
            return false;
          }
        }
        else {
          if (((ConstDeclImpl) obj).name_ != null) {
            return false;
          }
        }
        if (expr_ != null) {
          if (!expr_.equals(((ConstDeclImpl) obj).expr_)) {
            return false;
          }
        }
        else {
          if (((ConstDeclImpl) obj).expr_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ConstDeclVisitor) {
      net.sourceforge.czt.z.visitor.ConstDeclVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ConstDeclVisitor<R>) v;
