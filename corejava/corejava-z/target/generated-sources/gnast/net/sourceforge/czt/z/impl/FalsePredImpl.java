 ...
 * {@link net.sourceforge.czt.z.ast.FalsePred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class FalsePredImpl
extends 		 		net.sourceforge.czt.z.impl.FactImpl
 	  implements net.sourceforge.czt.z.ast.FalsePred
{
  ...
  /**
   * static instance count for FalsePredImpl
   */
   ...
   * this instance of FalsePredImpl (e.g., ic >= sl)
   */
  ...
  protected FalsePredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.FalsePredVisitor) {
      net.sourceforge.czt.z.visitor.FalsePredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.FalsePredVisitor<R>) v;
