 ...
 * {@link net.sourceforge.czt.z.ast.OutStroke}.
 *
 * @author GnAST version 1.6-cdh
 */
public class OutStrokeImpl
extends 		 		net.sourceforge.czt.z.impl.StrokeImpl
 	  implements net.sourceforge.czt.z.ast.OutStroke
{
  ...
  /**
   * static instance count for OutStrokeImpl
   */
   ...
   * this instance of OutStrokeImpl (e.g., ic >= sl)
   */
  ...
  protected OutStrokeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.OutStrokeVisitor) {
      net.sourceforge.czt.z.visitor.OutStrokeVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.OutStrokeVisitor<R>) v;
