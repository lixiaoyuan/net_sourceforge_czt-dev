 ...
 * {@link net.sourceforge.czt.z.ast.InStroke}.
 *
 * @author GnAST version 1.6-cdh
 */
public class InStrokeImpl
extends 		 		net.sourceforge.czt.z.impl.StrokeImpl
 	  implements net.sourceforge.czt.z.ast.InStroke
{
  ...
  /**
   * static instance count for InStrokeImpl
   */
   ...
   * this instance of InStrokeImpl (e.g., ic >= sl)
   */
  ...
  protected InStrokeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.InStrokeVisitor) {
      net.sourceforge.czt.z.visitor.InStrokeVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.InStrokeVisitor<R>) v;
