 ...
 * {@link net.sourceforge.czt.z.ast.NegPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class NegPredImpl
extends 		 		net.sourceforge.czt.z.impl.PredImpl
 	  implements net.sourceforge.czt.z.ast.NegPred
{
  ...
  /**
   * static instance count for NegPredImpl
   */
   ...
   * this instance of NegPredImpl (e.g., ic >= sl)
   */
  ...
  protected NegPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (pred_ != null) {
          if (!pred_.equals(((NegPredImpl) obj).pred_)) {
            return false;
          }
        }
        else {
          if (((NegPredImpl) obj).pred_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.NegPredVisitor) {
      net.sourceforge.czt.z.visitor.NegPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.NegPredVisitor<R>) v;
