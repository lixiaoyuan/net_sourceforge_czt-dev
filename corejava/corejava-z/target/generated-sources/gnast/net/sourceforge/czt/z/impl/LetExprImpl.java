 ...
 * {@link net.sourceforge.czt.z.ast.LetExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class LetExprImpl
extends 		 		net.sourceforge.czt.z.impl.Qnt1ExprImpl
 	  implements net.sourceforge.czt.z.ast.LetExpr
{
  ...
  /**
   * static instance count for LetExprImpl
   */
   ...
   * this instance of LetExprImpl (e.g., ic >= sl)
   */
  ...
  protected LetExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.LetExprVisitor) {
      net.sourceforge.czt.z.visitor.LetExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.LetExprVisitor<R>) v;
