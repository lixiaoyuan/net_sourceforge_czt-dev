 ...
 * {@link net.sourceforge.czt.z.ast.PowerType}.
 *
 * @author GnAST version 1.6-cdh
 */
public class PowerTypeImpl
extends 		 		net.sourceforge.czt.z.impl.Type2Impl
 	  implements net.sourceforge.czt.z.ast.PowerType
{
  ...
  /**
   * static instance count for PowerTypeImpl
   */
   ...
   * this instance of PowerTypeImpl (e.g., ic >= sl)
   */
  ...
  protected PowerTypeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (type_ != null) {
          if (!type_.equals(((PowerTypeImpl) obj).type_)) {
            return false;
          }
        }
        else {
          if (((PowerTypeImpl) obj).type_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.PowerTypeVisitor) {
      net.sourceforge.czt.z.visitor.PowerTypeVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.PowerTypeVisitor<R>) v;
