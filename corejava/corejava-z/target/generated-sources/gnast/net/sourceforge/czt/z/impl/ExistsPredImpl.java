 ...
 * {@link net.sourceforge.czt.z.ast.ExistsPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ExistsPredImpl
extends 		 		net.sourceforge.czt.z.impl.QntPredImpl
 	  implements net.sourceforge.czt.z.ast.ExistsPred
{
  ...
  /**
   * static instance count for ExistsPredImpl
   */
   ...
   * this instance of ExistsPredImpl (e.g., ic >= sl)
   */
  ...
  protected ExistsPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ExistsPredVisitor) {
      net.sourceforge.czt.z.visitor.ExistsPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ExistsPredVisitor<R>) v;
