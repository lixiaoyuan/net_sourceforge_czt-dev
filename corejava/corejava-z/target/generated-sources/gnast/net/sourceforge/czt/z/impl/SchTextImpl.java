	  ...
	  implements net.sourceforge.czt.z.ast.SchText
{
  ...
  protected SchTextImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.SchTextVisitor) {
      net.sourceforge.czt.z.visitor.SchTextVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.SchTextVisitor<R>) v;
