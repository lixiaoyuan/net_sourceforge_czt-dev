 ...
 * {@link net.sourceforge.czt.z.ast.FreePara}.
 *
 * @author GnAST version 1.6-cdh
 */
public class FreeParaImpl
extends 		 		net.sourceforge.czt.z.impl.ParaImpl
 	  implements net.sourceforge.czt.z.ast.FreePara
{
  ...
  /**
   * static instance count for FreeParaImpl
   */
   ...
   * this instance of FreeParaImpl (e.g., ic >= sl)
   */
  ...
  protected FreeParaImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
    ...
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (freetypeList_ != null) {
          if (!freetypeList_.equals(((FreeParaImpl) obj).freetypeList_)) {
            return false;
          }
        }
        else {
          if (((FreeParaImpl) obj).freetypeList_ != null) {
            return false;
          }
        }
        return true;
  ...
  public int hashCode()
  {
    ...
    if (freetypeList_ != null) {
      hashCode += 31 * freetypeList_.hashCode();
    }
    return hashCode;
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.FreeParaVisitor) {
      net.sourceforge.czt.z.visitor.FreeParaVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.FreeParaVisitor<R>) v;
  ...
  public FreeParaImpl create(Object[] args)
  {
    ...
    try {
						...
						net.sourceforge.czt.z.ast.FreetypeList) args[0];
