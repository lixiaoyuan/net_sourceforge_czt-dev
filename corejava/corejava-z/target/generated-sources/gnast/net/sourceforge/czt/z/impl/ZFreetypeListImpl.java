 ...
 * {@link net.sourceforge.czt.z.ast.ZFreetypeList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Freetype + net.sourceforge.czt.z.ast

public class ZFreetypeListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Freetype>
  implements net.sourceforge.czt.z.ast.ZFreetypeList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Freetype> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZFreetypeListImpl
   */
   ...
   * this instance of ZFreetypeListImpl (e.g., ic >= sl)
   */
  ...
  protected ZFreetypeListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Freetype> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Freetype>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.z.ast.ZFreetypeList getFreetype()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Freetype element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Freetype get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Freetype remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Freetype set(int index, net.sourceforge.czt.z.ast.Freetype element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ZFreetypeListVisitor) {
      net.sourceforge.czt.z.visitor.ZFreetypeListVisitor<R> visitor = 
      		(net.sourceforge.czt.z.visitor.ZFreetypeListVisitor<R>) v;
  ...
  public ZFreetypeListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Freetype) args[i]);
    }
    return result;
  }
}
