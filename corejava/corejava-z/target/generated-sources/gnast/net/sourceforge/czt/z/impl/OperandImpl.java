 ...
 * {@link net.sourceforge.czt.z.ast.Operand}.
 *
 * @author GnAST version 1.6-cdh
 */
public class OperandImpl
extends 		 		net.sourceforge.czt.z.impl.OperImpl
 	  implements net.sourceforge.czt.z.ast.Operand
{
  ...
  /**
   * static instance count for OperandImpl
   */
   ...
   * this instance of OperandImpl (e.g., ic >= sl)
   */
  ...
  protected OperandImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (list_ != null) {
          if (!list_.equals(((OperandImpl) obj).list_)) {
            return false;
          }
        }
        else {
          if (((OperandImpl) obj).list_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.OperandVisitor) {
      net.sourceforge.czt.z.visitor.OperandVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.OperandVisitor<R>) v;
