 ...
 * {@link net.sourceforge.czt.z.ast.ZExprList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Expr + net.sourceforge.czt.z.ast

public class ZExprListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Expr>
  implements net.sourceforge.czt.z.ast.ZExprList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Expr> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZExprListImpl
   */
   ...
   * this instance of ZExprListImpl (e.g., ic >= sl)
   */
  ...
  protected ZExprListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Expr> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Expr>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.z.ast.ZExprList getExpr()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Expr element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Expr get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Expr remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Expr set(int index, net.sourceforge.czt.z.ast.Expr element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ZExprListVisitor) {
      net.sourceforge.czt.z.visitor.ZExprListVisitor<R> visitor = 
      		(net.sourceforge.czt.z.visitor.ZExprListVisitor<R>) v;
  ...
  public ZExprListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Expr) args[i]);
    }
    return result;
  }
}
