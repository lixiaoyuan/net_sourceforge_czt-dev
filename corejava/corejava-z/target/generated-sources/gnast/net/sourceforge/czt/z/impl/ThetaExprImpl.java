 ...
 * {@link net.sourceforge.czt.z.ast.ThetaExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ThetaExprImpl
extends 		 		net.sourceforge.czt.z.impl.Expr1Impl
 	  implements net.sourceforge.czt.z.ast.ThetaExpr
{
  ...
  /**
   * static instance count for ThetaExprImpl
   */
   ...
   * this instance of ThetaExprImpl (e.g., ic >= sl)
   */
  ...
  protected ThetaExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (strokeList_ != null) {
          if (!strokeList_.equals(((ThetaExprImpl) obj).strokeList_)) {
            return false;
          }
        }
        else {
          if (((ThetaExprImpl) obj).strokeList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ThetaExprVisitor) {
      net.sourceforge.czt.z.visitor.ThetaExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ThetaExprVisitor<R>) v;
