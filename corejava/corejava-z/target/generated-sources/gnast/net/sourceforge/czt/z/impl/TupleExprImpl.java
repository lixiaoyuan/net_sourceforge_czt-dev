 ...
 * {@link net.sourceforge.czt.z.ast.TupleExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class TupleExprImpl
extends 		 		net.sourceforge.czt.z.impl.Expr2NImpl
 	  implements net.sourceforge.czt.z.ast.TupleExpr
{
  ...
  /**
   * static instance count for TupleExprImpl
   */
   ...
   * this instance of TupleExprImpl (e.g., ic >= sl)
   */
  ...
  protected TupleExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.TupleExprVisitor) {
      net.sourceforge.czt.z.visitor.TupleExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.TupleExprVisitor<R>) v;
  ...
  public TupleExprImpl create(Object[] args)
  {
    ...
    try {
						...
						net.sourceforge.czt.z.ast.ExprList) args[0];
