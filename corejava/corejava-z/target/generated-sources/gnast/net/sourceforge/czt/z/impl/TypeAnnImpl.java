 ...
 * {@link net.sourceforge.czt.z.ast.TypeAnn}.
 *
 * @author GnAST version 1.6-cdh
 */
public class TypeAnnImpl
extends 		 		net.sourceforge.czt.z.impl.AnnImpl
 	  implements net.sourceforge.czt.z.ast.TypeAnn
{
  ...
  /**
   * static instance count for TypeAnnImpl
   */
   ...
   * this instance of TypeAnnImpl (e.g., ic >= sl)
   */
  ...
  protected TypeAnnImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (type_ != null) {
          if (!type_.equals(((TypeAnnImpl) obj).type_)) {
            return false;
          }
        }
        else {
          if (((TypeAnnImpl) obj).type_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.TypeAnnVisitor) {
      net.sourceforge.czt.z.visitor.TypeAnnVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.TypeAnnVisitor<R>) v;
  ...
  public TypeAnnImpl create(Object[] args)
  {
    ...
    try {
						...
						net.sourceforge.czt.z.ast.Type) args[0];
