 ...
 * {@link net.sourceforge.czt.z.ast.ParenAnn}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ParenAnnImpl
extends 		 		net.sourceforge.czt.z.impl.AnnImpl
 	  implements net.sourceforge.czt.z.ast.ParenAnn
{
  ...
  /**
   * static instance count for ParenAnnImpl
   */
   ...
   * this instance of ParenAnnImpl (e.g., ic >= sl)
   */
  ...
  protected ParenAnnImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ParenAnnVisitor) {
      net.sourceforge.czt.z.visitor.ParenAnnVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ParenAnnVisitor<R>) v;
