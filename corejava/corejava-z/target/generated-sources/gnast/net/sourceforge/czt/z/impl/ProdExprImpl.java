 ...
 * {@link net.sourceforge.czt.z.ast.ProdExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ProdExprImpl
extends 		 		net.sourceforge.czt.z.impl.Expr2NImpl
 	  implements net.sourceforge.czt.z.ast.ProdExpr
{
  ...
  /**
   * static instance count for ProdExprImpl
   */
   ...
   * this instance of ProdExprImpl (e.g., ic >= sl)
   */
  ...
  protected ProdExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ProdExprVisitor) {
      net.sourceforge.czt.z.visitor.ProdExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ProdExprVisitor<R>) v;
