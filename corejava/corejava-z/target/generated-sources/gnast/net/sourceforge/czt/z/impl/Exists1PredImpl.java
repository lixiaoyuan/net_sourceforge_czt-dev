 ...
 * {@link net.sourceforge.czt.z.ast.Exists1Pred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class Exists1PredImpl
extends 		 		net.sourceforge.czt.z.impl.QntPredImpl
 	  implements net.sourceforge.czt.z.ast.Exists1Pred
{
  ...
  /**
   * static instance count for Exists1PredImpl
   */
   ...
   * this instance of Exists1PredImpl (e.g., ic >= sl)
   */
  ...
  protected Exists1PredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.Exists1PredVisitor) {
      net.sourceforge.czt.z.visitor.Exists1PredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.Exists1PredVisitor<R>) v;
