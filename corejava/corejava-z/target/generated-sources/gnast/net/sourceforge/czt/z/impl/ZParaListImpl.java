 ...
 * {@link net.sourceforge.czt.z.ast.ZParaList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Para + net.sourceforge.czt.z.ast

public class ZParaListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Para>
  implements net.sourceforge.czt.z.ast.ZParaList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Para> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZParaListImpl
   */
   ...
   * this instance of ZParaListImpl (e.g., ic >= sl)
   */
  ...
  protected ZParaListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Para> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Para>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.z.ast.ZParaList getPara()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Para element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Para get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Para remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Para set(int index, net.sourceforge.czt.z.ast.Para element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ZParaListVisitor) {
      net.sourceforge.czt.z.visitor.ZParaListVisitor<R> visitor = 
      		(net.sourceforge.czt.z.visitor.ZParaListVisitor<R>) v;
  ...
  public ZParaListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Para) args[i]);
    }
    return result;
  }
}
