 ...
 * {@link net.sourceforge.czt.z.ast.ForallExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ForallExprImpl
extends 		 		net.sourceforge.czt.z.impl.Qnt1ExprImpl
 	  implements net.sourceforge.czt.z.ast.ForallExpr
{
  ...
  /**
   * static instance count for ForallExprImpl
   */
   ...
   * this instance of ForallExprImpl (e.g., ic >= sl)
   */
  ...
  protected ForallExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ForallExprVisitor) {
      net.sourceforge.czt.z.visitor.ForallExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ForallExprVisitor<R>) v;
