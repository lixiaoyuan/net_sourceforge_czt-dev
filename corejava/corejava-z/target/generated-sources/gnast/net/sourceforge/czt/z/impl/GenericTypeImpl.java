 ...
 * {@link net.sourceforge.czt.z.ast.GenericType}.
 *
 * @author GnAST version 1.6-cdh
 */
public class GenericTypeImpl
extends 		 		net.sourceforge.czt.z.impl.TypeImpl
 	  implements net.sourceforge.czt.z.ast.GenericType
{
  ...
  /**
   * static instance count for GenericTypeImpl
   */
   ...
   * this instance of GenericTypeImpl (e.g., ic >= sl)
   */
  ...
  protected GenericTypeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (nameList_ != null) {
          if (!nameList_.equals(((GenericTypeImpl) obj).nameList_)) {
            return false;
          }
        }
        else {
          if (((GenericTypeImpl) obj).nameList_ != null) {
            return false;
          }
        }
        if (type_ != null) {
          if (!type_.equals(((GenericTypeImpl) obj).type_)) {
            return false;
          }
        }
        else {
          if (((GenericTypeImpl) obj).type_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.GenericTypeVisitor) {
      net.sourceforge.czt.z.visitor.GenericTypeVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.GenericTypeVisitor<R>) v;
