 ...
 * {@link net.sourceforge.czt.z.ast.PipeExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class PipeExprImpl
extends 		 		net.sourceforge.czt.z.impl.SchExpr2Impl
 	  implements net.sourceforge.czt.z.ast.PipeExpr
{
  ...
  /**
   * static instance count for PipeExprImpl
   */
   ...
   * this instance of PipeExprImpl (e.g., ic >= sl)
   */
  ...
  protected PipeExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.PipeExprVisitor) {
      net.sourceforge.czt.z.visitor.PipeExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.PipeExprVisitor<R>) v;
