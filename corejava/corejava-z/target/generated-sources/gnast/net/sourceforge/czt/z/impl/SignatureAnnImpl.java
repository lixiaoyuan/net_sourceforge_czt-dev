 ...
 * {@link net.sourceforge.czt.z.ast.SignatureAnn}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SignatureAnnImpl
extends 		 		net.sourceforge.czt.z.impl.AnnImpl
 	  implements net.sourceforge.czt.z.ast.SignatureAnn
{
  ...
  /**
   * static instance count for SignatureAnnImpl
   */
   ...
   * this instance of SignatureAnnImpl (e.g., ic >= sl)
   */
  ...
  protected SignatureAnnImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (signature_ != null) {
          if (!signature_.equals(((SignatureAnnImpl) obj).signature_)) {
            return false;
          }
        }
        else {
          if (((SignatureAnnImpl) obj).signature_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.SignatureAnnVisitor) {
      net.sourceforge.czt.z.visitor.SignatureAnnVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.SignatureAnnVisitor<R>) v;
