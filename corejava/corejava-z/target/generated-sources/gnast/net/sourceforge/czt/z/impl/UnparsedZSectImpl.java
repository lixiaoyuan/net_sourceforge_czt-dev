 ...
 * {@link net.sourceforge.czt.z.ast.UnparsedZSect}.
 *
 * @author GnAST version 1.6-cdh
 */
public class UnparsedZSectImpl
extends 		 		net.sourceforge.czt.z.impl.SectImpl
 	  implements net.sourceforge.czt.z.ast.UnparsedZSect
{
  ...
  /**
   * static instance count for UnparsedZSectImpl
   */
   ...
   * this instance of UnparsedZSectImpl (e.g., ic >= sl)
   */
  ...
  protected UnparsedZSectImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (content_ != null) {
          if (!content_.equals(((UnparsedZSectImpl) obj).content_)) {
            return false;
          }
        }
        else {
          if (((UnparsedZSectImpl) obj).content_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.UnparsedZSectVisitor) {
      net.sourceforge.czt.z.visitor.UnparsedZSectVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.UnparsedZSectVisitor<R>) v;
