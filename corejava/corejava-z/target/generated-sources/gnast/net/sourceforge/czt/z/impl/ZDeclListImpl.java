 ...
 * {@link net.sourceforge.czt.z.ast.ZDeclList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Decl + net.sourceforge.czt.z.ast

public class ZDeclListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Decl>
  implements net.sourceforge.czt.z.ast.ZDeclList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Decl> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZDeclListImpl
   */
   ...
   * this instance of ZDeclListImpl (e.g., ic >= sl)
   */
  ...
  protected ZDeclListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Decl> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Decl>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.z.ast.ZDeclList getDecl()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Decl element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Decl get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Decl remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Decl set(int index, net.sourceforge.czt.z.ast.Decl element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ZDeclListVisitor) {
      net.sourceforge.czt.z.visitor.ZDeclListVisitor<R> visitor = 
      		(net.sourceforge.czt.z.visitor.ZDeclListVisitor<R>) v;
  ...
  public ZDeclListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Decl) args[i]);
    }
    return result;
  }
}
