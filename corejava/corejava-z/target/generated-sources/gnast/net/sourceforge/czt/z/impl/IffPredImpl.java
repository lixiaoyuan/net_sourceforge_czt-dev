 ...
 * {@link net.sourceforge.czt.z.ast.IffPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class IffPredImpl
extends 		 		net.sourceforge.czt.z.impl.Pred2Impl
 	  implements net.sourceforge.czt.z.ast.IffPred
{
  ...
  /**
   * static instance count for IffPredImpl
   */
   ...
   * this instance of IffPredImpl (e.g., ic >= sl)
   */
  ...
  protected IffPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.IffPredVisitor) {
      net.sourceforge.czt.z.visitor.IffPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.IffPredVisitor<R>) v;
