 ...
 * {@link net.sourceforge.czt.z.ast.SetExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SetExprImpl
extends 		 		net.sourceforge.czt.z.impl.Expr0NImpl
 	  implements net.sourceforge.czt.z.ast.SetExpr
{
  ...
  /**
   * static instance count for SetExprImpl
   */
   ...
   * this instance of SetExprImpl (e.g., ic >= sl)
   */
  ...
  protected SetExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.SetExprVisitor) {
      net.sourceforge.czt.z.visitor.SetExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.SetExprVisitor<R>) v;
