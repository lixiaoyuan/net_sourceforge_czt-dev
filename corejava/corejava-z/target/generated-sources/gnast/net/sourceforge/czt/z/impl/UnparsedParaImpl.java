 ...
 * {@link net.sourceforge.czt.z.ast.UnparsedPara}.
 *
 * @author GnAST version 1.6-cdh
 */
public class UnparsedParaImpl
extends 		 		net.sourceforge.czt.z.impl.ParaImpl
 	  implements net.sourceforge.czt.z.ast.UnparsedPara
{
  ...
  /**
   * static instance count for UnparsedParaImpl
   */
   ...
   * this instance of UnparsedParaImpl (e.g., ic >= sl)
   */
  ...
  protected UnparsedParaImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (content_ != null) {
          if (!content_.equals(((UnparsedParaImpl) obj).content_)) {
            return false;
          }
        }
        else {
          if (((UnparsedParaImpl) obj).content_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.UnparsedParaVisitor) {
      net.sourceforge.czt.z.visitor.UnparsedParaVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.UnparsedParaVisitor<R>) v;
