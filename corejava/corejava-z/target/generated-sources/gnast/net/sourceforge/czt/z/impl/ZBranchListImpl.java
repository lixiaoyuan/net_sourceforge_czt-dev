 ...
 * {@link net.sourceforge.czt.z.ast.ZBranchList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Branch + net.sourceforge.czt.z.ast

public class ZBranchListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Branch>
  implements net.sourceforge.czt.z.ast.ZBranchList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Branch> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZBranchListImpl
   */
   ...
   * this instance of ZBranchListImpl (e.g., ic >= sl)
   */
  ...
  protected ZBranchListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Branch> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Branch>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.z.ast.ZBranchList getBranch()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Branch element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Branch get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Branch remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Branch set(int index, net.sourceforge.czt.z.ast.Branch element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ZBranchListVisitor) {
      net.sourceforge.czt.z.visitor.ZBranchListVisitor<R> visitor = 
      		(net.sourceforge.czt.z.visitor.ZBranchListVisitor<R>) v;
  ...
  public ZBranchListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Branch) args[i]);
    }
    return result;
  }
}
