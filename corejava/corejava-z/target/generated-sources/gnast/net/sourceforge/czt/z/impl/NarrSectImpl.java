 ...
 * {@link net.sourceforge.czt.z.ast.NarrSect}.
 *
 * @author GnAST version 1.6-cdh
 */
public class NarrSectImpl
extends 		 		net.sourceforge.czt.z.impl.SectImpl
 	  implements net.sourceforge.czt.z.ast.NarrSect
{
  ...
  /**
   * static instance count for NarrSectImpl
   */
   ...
   * this instance of NarrSectImpl (e.g., ic >= sl)
   */
  ...
  protected NarrSectImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (content_ != null) {
          if (!content_.equals(((NarrSectImpl) obj).content_)) {
            return false;
          }
        }
        else {
          if (((NarrSectImpl) obj).content_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.NarrSectVisitor) {
      net.sourceforge.czt.z.visitor.NarrSectVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.NarrSectVisitor<R>) v;
