 ...
 * {@link net.sourceforge.czt.z.ast.LambdaExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class LambdaExprImpl
extends 		 		net.sourceforge.czt.z.impl.Qnt1ExprImpl
 	  implements net.sourceforge.czt.z.ast.LambdaExpr
{
  ...
  /**
   * static instance count for LambdaExprImpl
   */
   ...
   * this instance of LambdaExprImpl (e.g., ic >= sl)
   */
  ...
  protected LambdaExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.LambdaExprVisitor) {
      net.sourceforge.czt.z.visitor.LambdaExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.LambdaExprVisitor<R>) v;
