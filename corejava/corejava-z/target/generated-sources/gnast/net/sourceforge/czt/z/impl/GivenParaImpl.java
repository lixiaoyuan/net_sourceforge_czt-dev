 ...
 * {@link net.sourceforge.czt.z.ast.GivenPara}.
 *
 * @author GnAST version 1.6-cdh
 */
public class GivenParaImpl
extends 		 		net.sourceforge.czt.z.impl.ParaImpl
 	  implements net.sourceforge.czt.z.ast.GivenPara
{
  ...
  /**
   * static instance count for GivenParaImpl
   */
   ...
   * this instance of GivenParaImpl (e.g., ic >= sl)
   */
  ...
  protected GivenParaImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (nameList_ != null) {
          if (!nameList_.equals(((GivenParaImpl) obj).nameList_)) {
            return false;
          }
        }
        else {
          if (((GivenParaImpl) obj).nameList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.GivenParaVisitor) {
      net.sourceforge.czt.z.visitor.GivenParaVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.GivenParaVisitor<R>) v;
