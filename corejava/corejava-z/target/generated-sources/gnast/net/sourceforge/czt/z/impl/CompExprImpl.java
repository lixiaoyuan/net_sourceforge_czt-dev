 ...
 * {@link net.sourceforge.czt.z.ast.CompExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class CompExprImpl
extends 		 		net.sourceforge.czt.z.impl.SchExpr2Impl
 	  implements net.sourceforge.czt.z.ast.CompExpr
{
  ...
  /**
   * static instance count for CompExprImpl
   */
   ...
   * this instance of CompExprImpl (e.g., ic >= sl)
   */
  ...
  protected CompExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.CompExprVisitor) {
      net.sourceforge.czt.z.visitor.CompExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.CompExprVisitor<R>) v;
