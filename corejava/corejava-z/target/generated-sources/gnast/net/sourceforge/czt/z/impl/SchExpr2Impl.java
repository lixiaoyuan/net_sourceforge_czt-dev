 ...
 * {@link net.sourceforge.czt.z.ast.SchExpr2}.
 *
 * @author GnAST version 1.6-cdh
 */
public abstract class SchExpr2Impl
extends 		 		net.sourceforge.czt.z.impl.Expr2Impl
 	  implements net.sourceforge.czt.z.ast.SchExpr2
{
  ...
  protected SchExpr2Impl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.SchExpr2Visitor) {
      net.sourceforge.czt.z.visitor.SchExpr2Visitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.SchExpr2Visitor<R>) v;
