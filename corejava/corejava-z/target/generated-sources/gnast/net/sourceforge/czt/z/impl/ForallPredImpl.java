 ...
 * {@link net.sourceforge.czt.z.ast.ForallPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ForallPredImpl
extends 		 		net.sourceforge.czt.z.impl.QntPredImpl
 	  implements net.sourceforge.czt.z.ast.ForallPred
{
  ...
  /**
   * static instance count for ForallPredImpl
   */
   ...
   * this instance of ForallPredImpl (e.g., ic >= sl)
   */
  ...
  protected ForallPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ForallPredVisitor) {
      net.sourceforge.czt.z.visitor.ForallPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ForallPredVisitor<R>) v;
