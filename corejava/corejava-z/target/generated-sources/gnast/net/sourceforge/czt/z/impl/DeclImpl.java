	  ...
	  implements net.sourceforge.czt.z.ast.Decl
{
  ...
  protected DeclImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.DeclVisitor) {
      net.sourceforge.czt.z.visitor.DeclVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.DeclVisitor<R>) v;
