 ...
 * {@link net.sourceforge.czt.z.ast.ImpliesPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ImpliesPredImpl
extends 		 		net.sourceforge.czt.z.impl.Pred2Impl
 	  implements net.sourceforge.czt.z.ast.ImpliesPred
{
  ...
  /**
   * static instance count for ImpliesPredImpl
   */
   ...
   * this instance of ImpliesPredImpl (e.g., ic >= sl)
   */
  ...
  protected ImpliesPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ImpliesPredVisitor) {
      net.sourceforge.czt.z.visitor.ImpliesPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ImpliesPredVisitor<R>) v;
