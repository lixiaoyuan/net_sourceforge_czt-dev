	  ...
	  implements net.sourceforge.czt.z.ast.Sect
{
  ...
  protected SectImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.SectVisitor) {
      net.sourceforge.czt.z.visitor.SectVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.SectVisitor<R>) v;
