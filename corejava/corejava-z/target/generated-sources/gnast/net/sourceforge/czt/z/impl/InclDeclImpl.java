 ...
 * {@link net.sourceforge.czt.z.ast.InclDecl}.
 *
 * @author GnAST version 1.6-cdh
 */
public class InclDeclImpl
extends 		 		net.sourceforge.czt.z.impl.DeclImpl
 	  implements net.sourceforge.czt.z.ast.InclDecl
{
  ...
  /**
   * static instance count for InclDeclImpl
   */
   ...
   * this instance of InclDeclImpl (e.g., ic >= sl)
   */
  ...
  protected InclDeclImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (expr_ != null) {
          if (!expr_.equals(((InclDeclImpl) obj).expr_)) {
            return false;
          }
        }
        else {
          if (((InclDeclImpl) obj).expr_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.InclDeclVisitor) {
      net.sourceforge.czt.z.visitor.InclDeclVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.InclDeclVisitor<R>) v;
