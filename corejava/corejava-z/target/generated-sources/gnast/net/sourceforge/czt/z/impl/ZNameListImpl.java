 ...
 * {@link net.sourceforge.czt.z.ast.ZNameList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Name + net.sourceforge.czt.z.ast

public class ZNameListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Name>
  implements net.sourceforge.czt.z.ast.ZNameList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Name> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZNameListImpl
   */
   ...
   * this instance of ZNameListImpl (e.g., ic >= sl)
   */
   ...
   */
  protected ZNameListImpl()
  {
    this(null);
  }

  protected ZNameListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Name> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Name>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Name element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Name get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Name remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Name set(int index, net.sourceforge.czt.z.ast.Name element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ZNameListVisitor) {
      net.sourceforge.czt.z.visitor.ZNameListVisitor<R> visitor = 
      		(net.sourceforge.czt.z.visitor.ZNameListVisitor<R>) v;
      return visitor.visitZNameList(this);
    }
  ...
  @Override
  public ZNameListImpl create(Object[] args)
  {
    ZNameListImpl result = new ZNameListImpl(factory_);
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Name) args[i]);
    }
    return result;
  }
}
