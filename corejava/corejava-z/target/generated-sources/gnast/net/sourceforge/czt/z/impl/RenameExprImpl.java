 ...
 * {@link net.sourceforge.czt.z.ast.RenameExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class RenameExprImpl
extends 		 		net.sourceforge.czt.z.impl.Expr1Impl
 	  implements net.sourceforge.czt.z.ast.RenameExpr
{
  ...
  /**
   * static instance count for RenameExprImpl
   */
   ...
   * this instance of RenameExprImpl (e.g., ic >= sl)
   */
  ...
  protected RenameExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (renameList_ != null) {
          if (!renameList_.equals(((RenameExprImpl) obj).renameList_)) {
            return false;
          }
        }
        else {
          if (((RenameExprImpl) obj).renameList_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.RenameExprVisitor) {
      net.sourceforge.czt.z.visitor.RenameExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.RenameExprVisitor<R>) v;
