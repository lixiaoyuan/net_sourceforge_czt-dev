 	  ...
 	  implements net.sourceforge.czt.z.ast.Fact
{
  ...
  protected FactImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.FactVisitor) {
      net.sourceforge.czt.z.visitor.FactVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.FactVisitor<R>) v;
