 ...
 * {@link net.sourceforge.czt.z.ast.AndPred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class AndPredImpl
extends 		 		net.sourceforge.czt.z.impl.Pred2Impl
 	  implements net.sourceforge.czt.z.ast.AndPred
{
  ...
  /**
   * static instance count for AndPredImpl
   */
   ...
   * this instance of AndPredImpl (e.g., ic >= sl)
   */
  ...
  protected AndPredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (and_ != null) {
          if (!and_.equals(((AndPredImpl) obj).and_)) {
            return false;
          }
        }
        else {
          if (((AndPredImpl) obj).and_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.AndPredVisitor) {
      net.sourceforge.czt.z.visitor.AndPredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.AndPredVisitor<R>) v;
  ...
  public AndPredImpl create(Object[] args)
  {
    ...
    try {
	  	...
	  	pred = (java.util.List<net.sourceforge.czt.z.ast.Pred>) args[0];
