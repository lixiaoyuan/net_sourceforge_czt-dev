...
public interface Freetype extends   		net.sourceforge.czt.base.ast.Term
			{
   ...
   */
  net.sourceforge.czt.z.ast.BranchList getBranchList();
   ...
   * @see #getBranchList
   */
  void setBranchList(net.sourceforge.czt.z.ast.BranchList branchList);
