 ...
 * {@link net.sourceforge.czt.z.ast.TruePred}.
 *
 * @author GnAST version 1.6-cdh
 */
public class TruePredImpl
extends 		 		net.sourceforge.czt.z.impl.FactImpl
 	  implements net.sourceforge.czt.z.ast.TruePred
{
  ...
  /**
   * static instance count for TruePredImpl
   */
   ...
   * this instance of TruePredImpl (e.g., ic >= sl)
   */
  ...
  protected TruePredImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.TruePredVisitor) {
      net.sourceforge.czt.z.visitor.TruePredVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.TruePredVisitor<R>) v;
