 ...
 * {@link net.sourceforge.czt.z.ast.ProjExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class ProjExprImpl
extends 		 		net.sourceforge.czt.z.impl.SchExpr2Impl
 	  implements net.sourceforge.czt.z.ast.ProjExpr
{
  ...
  /**
   * static instance count for ProjExprImpl
   */
   ...
   * this instance of ProjExprImpl (e.g., ic >= sl)
   */
  ...
  protected ProjExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ProjExprVisitor) {
      net.sourceforge.czt.z.visitor.ProjExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.ProjExprVisitor<R>) v;
