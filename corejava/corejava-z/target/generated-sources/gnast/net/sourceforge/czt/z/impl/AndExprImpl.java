 ...
 * {@link net.sourceforge.czt.z.ast.AndExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class AndExprImpl
extends 		 		net.sourceforge.czt.z.impl.SchExpr2Impl
 	  implements net.sourceforge.czt.z.ast.AndExpr
{
  ...
  /**
   * static instance count for AndExprImpl
   */
   ...
   * this instance of AndExprImpl (e.g., ic >= sl)
   */
  ...
  protected AndExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.AndExprVisitor) {
      net.sourceforge.czt.z.visitor.AndExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.AndExprVisitor<R>) v;
