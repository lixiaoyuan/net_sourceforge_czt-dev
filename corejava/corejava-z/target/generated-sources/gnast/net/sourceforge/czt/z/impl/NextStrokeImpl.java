 ...
 * {@link net.sourceforge.czt.z.ast.NextStroke}.
 *
 * @author GnAST version 1.6-cdh
 */
public class NextStrokeImpl
extends 		 		net.sourceforge.czt.z.impl.StrokeImpl
 	  implements net.sourceforge.czt.z.ast.NextStroke
{
  ...
  /**
   * static instance count for NextStrokeImpl
   */
   ...
   * this instance of NextStrokeImpl (e.g., ic >= sl)
   */
  ...
  protected NextStrokeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.NextStrokeVisitor) {
      net.sourceforge.czt.z.visitor.NextStrokeVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.NextStrokeVisitor<R>) v;
