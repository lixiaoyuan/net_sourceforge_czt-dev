...
public interface UnparsedZSect extends 		 		net.sourceforge.czt.z.ast.Sect
 			{
   ...
   */
  java.util.List<? extends Object> getContent();
   ...
   * @see #getContent
   */
  void setContent(java.util.List<? extends Object> content);
}
