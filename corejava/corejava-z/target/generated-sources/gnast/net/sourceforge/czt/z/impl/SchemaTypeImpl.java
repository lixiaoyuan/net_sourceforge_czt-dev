 ...
 * {@link net.sourceforge.czt.z.ast.SchemaType}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SchemaTypeImpl
extends 		 		net.sourceforge.czt.z.impl.Type2Impl
 	  implements net.sourceforge.czt.z.ast.SchemaType
{
  ...
  /**
   * static instance count for SchemaTypeImpl
   */
   ...
   * this instance of SchemaTypeImpl (e.g., ic >= sl)
   */
  ...
  protected SchemaTypeImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj != null) {
      if (this.getClass().equals(obj.getClass()) && super.equals(obj)) {
        ...
        if (signature_ != null) {
          if (!signature_.equals(((SchemaTypeImpl) obj).signature_)) {
            return false;
          }
        }
        else {
          if (((SchemaTypeImpl) obj).signature_ != null) {
            return false;
          }
        }
        return true;
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.SchemaTypeVisitor) {
      net.sourceforge.czt.z.visitor.SchemaTypeVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.SchemaTypeVisitor<R>) v;
