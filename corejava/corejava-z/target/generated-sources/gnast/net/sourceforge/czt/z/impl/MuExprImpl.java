 ...
 * {@link net.sourceforge.czt.z.ast.MuExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class MuExprImpl
extends 		 		net.sourceforge.czt.z.impl.QntExprImpl
 	  implements net.sourceforge.czt.z.ast.MuExpr
{
  ...
  /**
   * static instance count for MuExprImpl
   */
   ...
   * this instance of MuExprImpl (e.g., ic >= sl)
   */
  ...
  protected MuExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.MuExprVisitor) {
      net.sourceforge.czt.z.visitor.MuExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.MuExprVisitor<R>) v;
