 ...
 * {@link net.sourceforge.czt.z.ast.NegExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class NegExprImpl
extends 		 		net.sourceforge.czt.z.impl.Expr1Impl
 	  implements net.sourceforge.czt.z.ast.NegExpr
{
  ...
  /**
   * static instance count for NegExprImpl
   */
   ...
   * this instance of NegExprImpl (e.g., ic >= sl)
   */
  ...
  protected NegExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.NegExprVisitor) {
      net.sourceforge.czt.z.visitor.NegExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.NegExprVisitor<R>) v;
