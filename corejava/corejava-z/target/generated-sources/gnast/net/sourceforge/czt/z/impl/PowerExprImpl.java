 ...
 * {@link net.sourceforge.czt.z.ast.PowerExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class PowerExprImpl
extends 		 		net.sourceforge.czt.z.impl.Expr1Impl
 	  implements net.sourceforge.czt.z.ast.PowerExpr
{
  ...
  /**
   * static instance count for PowerExprImpl
   */
   ...
   * this instance of PowerExprImpl (e.g., ic >= sl)
   */
  ...
  protected PowerExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.PowerExprVisitor) {
      net.sourceforge.czt.z.visitor.PowerExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.PowerExprVisitor<R>) v;
