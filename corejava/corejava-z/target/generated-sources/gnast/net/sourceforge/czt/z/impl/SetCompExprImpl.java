 ...
 * {@link net.sourceforge.czt.z.ast.SetCompExpr}.
 *
 * @author GnAST version 1.6-cdh
 */
public class SetCompExprImpl
extends 		 		net.sourceforge.czt.z.impl.QntExprImpl
 	  implements net.sourceforge.czt.z.ast.SetCompExpr
{
  ...
  /**
   * static instance count for SetCompExprImpl
   */
   ...
   * this instance of SetCompExprImpl (e.g., ic >= sl)
   */
  ...
  protected SetCompExprImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super(factory);
    countInstance();
  }
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.SetCompExprVisitor) {
      net.sourceforge.czt.z.visitor.SetCompExprVisitor<R> visitor = 
      	  (net.sourceforge.czt.z.visitor.SetCompExprVisitor<R>) v;
