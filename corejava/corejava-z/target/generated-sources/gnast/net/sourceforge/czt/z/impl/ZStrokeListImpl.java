 ...
 * {@link net.sourceforge.czt.z.ast.ZStrokeList}.
 *
 * @author GnAST version 1.6-cdh
 */
// net.sourceforge.czt.z.ast.Stroke + net.sourceforge.czt.z.ast

public class ZStrokeListImpl
  extends java.util.AbstractList<net.sourceforge.czt.z.ast.Stroke>
  implements net.sourceforge.czt.z.ast.ZStrokeList
{
   ...
   */
  /*@ non_null @*/
  private java.util.List<net.sourceforge.czt.z.ast.Stroke> list_;
  ...
  private java.util.List<Object> anns_;
    ...
    /**
   * static instance count for ZStrokeListImpl
   */
   ...
   * this instance of ZStrokeListImpl (e.g., ic >= sl)
   */
  ...
  protected ZStrokeListImpl(net.sourceforge.czt.base.impl.BaseFactory factory)
  {
    super();
    factory_ = factory;
    anns_ = null;
  ...
  protected java.util.List<net.sourceforge.czt.z.ast.Stroke> getList()
  {
    if (list_ == null) list_ = new java.util.ArrayList<net.sourceforge.czt.z.ast.Stroke>(net.sourceforge.czt.base.util.PerformanceSettings.INITIAL_ARRAY_CAPACITY);
    return list_;
  }
  ...
  public net.sourceforge.czt.z.ast.ZStrokeList getStroke()
  {
    return this;
  }
   ...
   */
  @Override
  public void add(int index, net.sourceforge.czt.z.ast.Stroke element)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Stroke get(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Stroke remove(int index)
  {
   ...
   */
  @Override
  public net.sourceforge.czt.z.ast.Stroke set(int index, net.sourceforge.czt.z.ast.Stroke element)
  {
  ...
  {
    if (v instanceof net.sourceforge.czt.z.visitor.ZStrokeListVisitor) {
      net.sourceforge.czt.z.visitor.ZStrokeListVisitor<R> visitor = 
      		(net.sourceforge.czt.z.visitor.ZStrokeListVisitor<R>) v;
  ...
  public ZStrokeListImpl create(Object[] args)
  {
    ...
    for (int i = 0; i < args.length; i++) {
      result.add((net.sourceforge.czt.z.ast.Stroke) args[i]);
    }
    return result;
  }
}
