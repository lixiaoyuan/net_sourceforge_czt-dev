...
/** CUP v0.11a czt01 beta generated parser.
  ...
  */
public class Unicode2OldLatex extends java_cup.runtime.lr_parser {

  /** Default constructor. */
  public Unicode2OldLatex() {super();}

  /** Constructor which sets the default scanner. */
  public Unicode2OldLatex(java_cup.runtime.Scanner s) {super(s);}

  /** Constructor which sets the default scanner. */
  public Unicode2OldLatex(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {super(s,sf);}
  ...
  protected void init_actions()
    {
      action_obj = new CUP$Unicode2OldLatex$actions(this);
    }
    ...
    throws java.lang.Exception
  {
    ...
    return action_obj.CUP$Unicode2OldLatex$do_action(act_num, parser, stack, top);
  }
 ...
 return local_next_token(); 
  ...
  private final Dialect dialect_ = 
    ...
    public Unicode2OldLatex(CztScanner scanner,
                    ...
                    Collection<? extends Key<?>> explicitDeps)
    {
      ...
      CztLogger.getLogger(Unicode2OldLatex.class).finer("New " + Unicode2OldLatex.class.getName() + 
  ...
  private void checkDialectConsistency(Dialect... vars)
  {
	  ...
	  if (!d.isExtensionOf(dialect_))
	  	throw new IllegalArgumentException("Incompatible dialects in " + 
	  		Unicode2OldLatex.class.getName() + " scanner. " + dialect_.toString() +
   ...
   protected void raiseErrors() throws PrintException
   {
     ...
     while (it.hasNext())
     {
       ...
       if (e.getErrorType().equals(ErrorType.WARNING))
       {
         ...
         CztLogger.getLogger(Unicode2OldLatex.class).warning(e.toString());
       }
     }
     it = null;
  ...
  protected void write(String s)
  {
    try {
      writer_.write(s);
    	...
    	CztLogger.getLogger(Unicode2OldLatex.class).severe("Could not write because of IO exception for " 
    	  + dialect_.toString() + " in Unicode2OldLatex as: " + e.getMessage());
    }
  }
    ...
    throws Exception
  {
    ...
    String logMessage =
      ...
      (result.sym != Sym.TEXT ? String.valueOf(result.value) + ", " + 
       ...
       "...shhh...") + ").";    
    CztLogger.getLogger(Unicode2OldLatex.class).fine(logMessage);
    return result;
  }
...
class CUP$Unicode2OldLatex$actions {
    ...
    throws PrintException
  {
    ...
    //		+ latexStr.replaceAll(" ", "") 
    //		
    //		+ " for " + dialect_.toString() + " in Unicode2OldLatex.");
    //
  ...
  private void addParentMarkups(ZSect zsect, LatexMarkupFunction table)
  {
    for (Parent parent : zsect.getParent()) {
      ...
      try {
        ...
        CztLogger.getLogger(Unicode2OldLatex.class).warning(message);
      }
      if (parentMarkup == null) {
        ...
        try {
          ...
          CztLogger.getLogger(Unicode2OldLatex.class).warning(e.getMessage());
        }
      }
    }
  }
  ...
  private final Unicode2OldLatex parser;

  /** Constructor */
  CUP$Unicode2OldLatex$actions(Unicode2OldLatex parser) {
    this.parser = parser;
  }

  /** Method with the actual generated action code. */
  public final java_cup.runtime.Symbol CUP$Unicode2OldLatex$do_action(
    int                        CUP$Unicode2OldLatex$act_num,
    java_cup.runtime.lr_parser CUP$Unicode2OldLatex$parser,
    java.util.Stack<java_cup.runtime.Symbol> CUP$Unicode2OldLatex$stack,
    int                        CUP$Unicode2OldLatex$top)
    throws java.lang.Exception
    {
      /* Symbol object for return from actions */
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;

      /* select the action based on the action number */
      switch (CUP$Unicode2OldLatex$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 58: // indent ::= INDENT 
            {
               CUP$Unicode2OldLatex$result = case58(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
            }
          return CUP$Unicode2OldLatex$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 57: // special ::= indent 
            {
               CUP$Unicode2OldLatex$result = case57(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 56: // special ::= NL 
            {
               CUP$Unicode2OldLatex$result = case56(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 55: // specialSeq ::= 
            {
               CUP$Unicode2OldLatex$result = case55(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 54: // specialSeq ::= specialSeq special 
            {
               CUP$Unicode2OldLatex$result = case54(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 53: // paren ::= RDATA 
            {
               CUP$Unicode2OldLatex$result = case53(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 52: // paren ::= LDATA 
            {
               CUP$Unicode2OldLatex$result = case52(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 51: // paren ::= RBIND 
            {
               CUP$Unicode2OldLatex$result = case51(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 50: // paren ::= LBIND 
            {
               CUP$Unicode2OldLatex$result = case50(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 49: // paren ::= RBRACE 
            {
               CUP$Unicode2OldLatex$result = case49(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 48: // paren ::= LBRACE 
            {
               CUP$Unicode2OldLatex$result = case48(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 47: // paren ::= RSQUARE 
            {
               CUP$Unicode2OldLatex$result = case47(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 46: // paren ::= LSQUARE 
            {
               CUP$Unicode2OldLatex$result = case46(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 45: // paren ::= RPAREN 
            {
               CUP$Unicode2OldLatex$result = case45(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 44: // paren ::= LPAREN 
            {
               CUP$Unicode2OldLatex$result = case44(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 43: // decorword ::= DECORWORD 
            {
               CUP$Unicode2OldLatex$result = case43(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 42: // schGenerics ::= LSQUARE decorwordList RSQUARE 
            {
               CUP$Unicode2OldLatex$result = case42(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 41: // decorwordList ::= decorword 
            {
               CUP$Unicode2OldLatex$result = case41(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 40: // decorwordList ::= decorwordList decorword 
            {
               CUP$Unicode2OldLatex$result = case40(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 39: // decorwordList ::= decorwordList special 
            {
               CUP$Unicode2OldLatex$result = case39(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 38: // token ::= WHERE 
            {
               CUP$Unicode2OldLatex$result = case38(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 37: // token ::= paren 
            {
               CUP$Unicode2OldLatex$result = case37(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 36: // token ::= NUMERAL 
            {
               CUP$Unicode2OldLatex$result = case36(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 35: // token ::= NUMSTROKE 
            {
               CUP$Unicode2OldLatex$result = case35(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 34: // token ::= NEXTSTROKE 
            {
               CUP$Unicode2OldLatex$result = case34(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 33: // token ::= OUTSTROKE 
            {
               CUP$Unicode2OldLatex$result = case33(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 32: // token ::= INSTROKE 
            {
               CUP$Unicode2OldLatex$result = case32(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 31: // token ::= decorword 
            {
               CUP$Unicode2OldLatex$result = case31(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 30: // tokenSeq ::= 
            {
               CUP$Unicode2OldLatex$result = case30(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 29: // tokenSeq ::= tokenSeq special 
            {
               CUP$Unicode2OldLatex$result = case29(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 28: // tokenSeq ::= tokenSeq token 
            {
               CUP$Unicode2OldLatex$result = case28(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 27: // wordmarkup ::= POSTWORD_MARKUP 
            {
               CUP$Unicode2OldLatex$result = case27(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 26: // wordmarkup ::= PREWORD_MARKUP 
            {
               CUP$Unicode2OldLatex$result = case26(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 25: // wordmarkup ::= INWORD_MARKUP 
            {
               CUP$Unicode2OldLatex$result = case25(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 24: // wordmarkup ::= WORD_MARKUP 
            {
               CUP$Unicode2OldLatex$result = case24(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 23: // markup ::= wordmarkup tokenSeq END_MARKUP 
            {
               CUP$Unicode2OldLatex$result = case23(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 22: // markup ::= CHAR_MARKUP 
            {
               CUP$Unicode2OldLatex$result = case22(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 21: // zpara ::= GENSCH specialSeq decorword schGenerics tokenSeq END 
            {
               CUP$Unicode2OldLatex$result = case21(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 20: // zpara ::= GENAX tokenSeq END 
            {
               CUP$Unicode2OldLatex$result = case20(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 19: // zpara ::= SCH specialSeq decorword tokenSeq END 
            {
               CUP$Unicode2OldLatex$result = case19(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 18: // zpara ::= AX tokenSeq END 
            {
               CUP$Unicode2OldLatex$result = case18(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 17: // zpara ::= ZED specialSeq zedPara END 
            {
               CUP$Unicode2OldLatex$result = case17(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 16: // zpara ::= ZED THEOREM decorword tokenSeq END 
            {
               CUP$Unicode2OldLatex$result = case16(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 15: // sectHeadSeq ::= 
            {
               CUP$Unicode2OldLatex$result = case15(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 14: // sectHeadSeq ::= sectHeadSeq special 
            {
               CUP$Unicode2OldLatex$result = case14(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 13: // sectHeadSeq ::= sectHeadSeq parentsHead 
            {
               CUP$Unicode2OldLatex$result = case13(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 12: // parentsHead ::= DECORWORD 
            {
               CUP$Unicode2OldLatex$result = case12(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 11: // parentsHead ::= PARENTS 
            {
               CUP$Unicode2OldLatex$result = case11(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 10: // zedPara ::= token tokenSeq 
            {
               CUP$Unicode2OldLatex$result = case10(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 9: // zedPara ::= SECTION specialSeq DECORWORD sectHeadSeq 
            {
               CUP$Unicode2OldLatex$result = case9(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 8: // para ::= zpara 
            {
               CUP$Unicode2OldLatex$result = case8(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 7: // para ::= TEXT 
            {
               CUP$Unicode2OldLatex$result = case7(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 6: // para ::= markup 
            {
               CUP$Unicode2OldLatex$result = case6(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 5: // paragraphList ::= 
            {
               CUP$Unicode2OldLatex$result = case5(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 4: // paragraphList ::= paragraphList para 
            {
               CUP$Unicode2OldLatex$result = case4(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 3: // input ::= PARA_START zpara PARA_END 
            {
               CUP$Unicode2OldLatex$result = case3(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 2: // input ::= TOKENSEQ tokenSeq TOKENSEQ 
            {
               CUP$Unicode2OldLatex$result = case2(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          case 1: // $START ::= input EOF 
            {
               CUP$Unicode2OldLatex$result = case1(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
          ...
          /* ACCEPT */
          CUP$Unicode2OldLatex$parser.done_parsing();
          return CUP$Unicode2OldLatex$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 0: // input ::= paragraphList 
            {
               CUP$Unicode2OldLatex$result = case0(
                 CUP$Unicode2OldLatex$act_num,
                 CUP$Unicode2OldLatex$parser,
                 CUP$Unicode2OldLatex$stack,
                 CUP$Unicode2OldLatex$top);
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		int indentleft = CUP$Unicode2OldLatex$stack.peek().left;
		int indentright = CUP$Unicode2OldLatex$stack.peek().right;
		String indent = (String) CUP$Unicode2OldLatex$stack.peek().value;
             ...
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("indent",16, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      LatexCommand RESULT =null;/*3*/
		int ileft = CUP$Unicode2OldLatex$stack.peek().left;
		int iright = CUP$Unicode2OldLatex$stack.peek().right;
		LatexCommand i = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
		
                RESULT = i;
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("special",15, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
                ...
                RESULT = null;
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("specialSeq",10, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      LatexCommand RESULT =null;/*3*/
		int sqleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int sqright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand sq = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		int sleft = CUP$Unicode2OldLatex$stack.peek().left;
		int sright = CUP$Unicode2OldLatex$stack.peek().right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
                ...
                if (sq != null)
                  ...
                  RESULT = s;
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("specialSeq",10, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		 RESULT = resultTT("\\rdata", ZString.RDATA); /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("paren",14, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		int sleft = CUP$Unicode2OldLatex$stack.peek().left;
		int sright = CUP$Unicode2OldLatex$stack.peek().right;
		Decorword s = (Decorword) CUP$Unicode2OldLatex$stack.peek().value;
             ...
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("decorword",17, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      LatexCommand RESULT =null;/*3*/
		int dwlleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int dwlright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand dwl = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		
               RESULT = concate(resultTT("[", ZString.LSQUARE),
                          concate(dwl, resultTT("]", ZString.RSQUARE)));
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("schGenerics",12, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		...
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
                 ...
                 RESULT = s;
              /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("decorwordList",13, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      LatexCommand RESULT =null;/*3*/
		int dwleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int dwright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand dw = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		int sleft = CUP$Unicode2OldLatex$stack.peek().left;
		int sright = CUP$Unicode2OldLatex$stack.peek().right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
                 ...
                 RESULT = concate(dw, s);
              /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("decorwordList",13, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      LatexCommand RESULT =null;/*3*/
		int dw1left = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int dw1right = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand dw1 = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		int dw2left = CUP$Unicode2OldLatex$stack.peek().left;
		int dw2right = CUP$Unicode2OldLatex$stack.peek().right;
		LatexCommand dw2 = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      LatexCommand RESULT =null;/*3*/
		int tleft = CUP$Unicode2OldLatex$stack.peek().left;
		int tright = CUP$Unicode2OldLatex$stack.peek().right;
		Object t = (Object) CUP$Unicode2OldLatex$stack.peek().value;
		
                RESULT = resultTT("\n\\where\n", ZString.NL + ZString.VL); /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("token",8, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		int ileft = CUP$Unicode2OldLatex$stack.peek().left;
		int iright = CUP$Unicode2OldLatex$stack.peek().right;
		LocInt i = (LocInt) CUP$Unicode2OldLatex$stack.peek().value;
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		 RESULT = null; /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("tokenSeq",9, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      LatexCommand RESULT =null;/*3*/
		int w1left = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int w1right = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand w1 = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		int w2left = CUP$Unicode2OldLatex$stack.peek().left;
		int w2right = CUP$Unicode2OldLatex$stack.peek().right;
		LatexCommand w2 = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
		 RESULT = concate(w1, w2); /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("tokenSeq",9, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      String RESULT =null;/*3*/
		int postwordleft = CUP$Unicode2OldLatex$stack.peek().left;
		int postwordright = CUP$Unicode2OldLatex$stack.peek().right;
		String postword = (String) CUP$Unicode2OldLatex$stack.peek().value;
		
                RESULT = "%%Zpostword " + postword;
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("wordmarkup",6, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int prewordleft = CUP$Unicode2OldLatex$stack.peek().left;
		int prewordright = CUP$Unicode2OldLatex$stack.peek().right;
		String preword = (String) CUP$Unicode2OldLatex$stack.peek().value;
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int inwordleft = CUP$Unicode2OldLatex$stack.peek().left;
		int inwordright = CUP$Unicode2OldLatex$stack.peek().right;
		String inword = (String) CUP$Unicode2OldLatex$stack.peek().value;
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int wordleft = CUP$Unicode2OldLatex$stack.peek().left;
		int wordright = CUP$Unicode2OldLatex$stack.peek().right;
		String word = (String) CUP$Unicode2OldLatex$stack.peek().value;
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int wmleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).left;
		int wmright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).right;
		String wm = (String) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).value;
		int sleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int sright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
             ...
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("markup",2, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int zcharleft = CUP$Unicode2OldLatex$stack.peek().left;
		int zcharright = CUP$Unicode2OldLatex$stack.peek().right;
		String zchar = (String) CUP$Unicode2OldLatex$stack.peek().value;
		 parser.write(zchar); /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("markup",2, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int wleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-3).left;
		int wright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-3).right;
		LatexCommand w = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-3).value;
		int genleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).left;
		int genright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).right;
		LatexCommand gen = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).value;
		int sleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int sright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
                ...
                parser.write(result);
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("zpara",4, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-5), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      String RESULT =null;/*3*/
		...
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
                ...
                parser.write(result);
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("zpara",4, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int wleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).left;
		int wright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).right;
		LatexCommand w = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2).value;
		int sleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int sright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
                ...
                parser.write(result);
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("zpara",4, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-4), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("zpara",4, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-3), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		 RESULT = null; /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("sectHeadSeq",11, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
      ...
      LatexCommand RESULT =null;/*3*/
		...
		LatexCommand w2 = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
		 RESULT = concate(s, w2); /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("sectHeadSeq",11, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      LatexCommand RESULT =null;/*3*/
		...
		int sright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		int dwleft = CUP$Unicode2OldLatex$stack.peek().left;
		int dwright = CUP$Unicode2OldLatex$stack.peek().right;
		Decorword dw = (Decorword) CUP$Unicode2OldLatex$stack.peek().value;
    ...
    throws java.lang.Exception
    {
      ...
      Decorword RESULT =null;/*3*/
		...
		Decorword dw = (Decorword) CUP$Unicode2OldLatex$stack.peek().value;
   			 	...
   			 	RESULT = dw;
   			 /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("parentsHead",7, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int tleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int tright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		LatexCommand t = (LatexCommand) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		int sleft = CUP$Unicode2OldLatex$stack.peek().left;
		int sright = CUP$Unicode2OldLatex$stack.peek().right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
                ...
                parser.write(result);
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("zedPara",5, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      String RESULT =null;/*3*/
		int dwleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int dwright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		Decorword dw = (Decorword) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		int sleft = CUP$Unicode2OldLatex$stack.peek().left;
		int sright = CUP$Unicode2OldLatex$stack.peek().right;
		LatexCommand s = (LatexCommand) CUP$Unicode2OldLatex$stack.peek().value;
                ...
                setupMarkupTable(table);
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("zedPara",5, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-3), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      String RESULT =null;/*3*/
		int zleft = CUP$Unicode2OldLatex$stack.peek().left;
		int zright = CUP$Unicode2OldLatex$stack.peek().right;
		String z = (String) CUP$Unicode2OldLatex$stack.peek().value;
		 RESULT = z; /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("para",3, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      String RESULT =null;/*3*/
		int tleft = CUP$Unicode2OldLatex$stack.peek().left;
		int tright = CUP$Unicode2OldLatex$stack.peek().right;
		LocString t = (LocString) CUP$Unicode2OldLatex$stack.peek().value;
    ...
    throws java.lang.Exception
    {
      ...
      Object RESULT =null;/*3*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("paragraphList",1, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      Object RESULT =null;/*3*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("paragraphList",1, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      Object RESULT =null;/*3*/
             ...
             /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("input",0, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-2), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      java_cup.runtime.Symbol CUP$Unicode2OldLatex$result;
      Object RESULT =null;/*3*/
		int start_valleft = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).left;
		int start_valright = CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).right;
		Object start_val = (Object) CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1).value;
		RESULT = start_val;/*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("$START",0, CUP$Unicode2OldLatex$stack.elementAt(CUP$Unicode2OldLatex$top-1), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
    ...
    throws java.lang.Exception
    {
      ...
      Object RESULT =null;/*3*/
		 parser.getWriter().flush(); /*5*/
              CUP$Unicode2OldLatex$result = parser.getSymbolFactory().newSymbol("input",0, CUP$Unicode2OldLatex$stack.peek(), CUP$Unicode2OldLatex$stack.peek(), RESULT); /*6*/
      return CUP$Unicode2OldLatex$result;/*8*/
