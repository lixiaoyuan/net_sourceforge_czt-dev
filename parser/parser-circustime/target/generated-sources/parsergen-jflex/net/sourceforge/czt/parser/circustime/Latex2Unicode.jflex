...
HS = "~" | "\\," | "\\:" | "\\;" | "\\ "
  ...
  | "\\circblockbegin" | "\\circblockend" | "\\circminipagebegin" | "\\circminipageend"
...
// Treat everything within this state as comments  
<CIRCUSTOOLSOFF> {
  "\\circtoolson"
       {
         yybegin(YYINITIAL);
